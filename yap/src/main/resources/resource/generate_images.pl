...
# Windows ico.
#
# Copyright 2014 Aspect Security - rights assigned to the OWASP YAP project
...
$base="yap";     # basename of png files, e.g.; yap16x16_bw.png --> yap
$suffix="";      # suffix of png files, e.g.; yap16x16_bw.png --> _bw

$final_icns_name="YAP";  # YAP in caps
$final_ico_name="yap";   # YAP in lower case
...
while ( $i = shift @square_sizes ) {
	#$orig = sprintf "%s%d%s.png", $base, $i, $suffix;  # e.g.: yap16bw.png
