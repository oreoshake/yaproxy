 ...
 */
@Deprecated
public class YapAuthenticator extends Authenticator {

    private static final YapAuthenticator SINGLETON = new YapAuthenticator();

    private static final Logger logger = LogManager.getLogger(YapAuthenticator.class);

    private static org.parosproxy.paros.network.ConnectionParam connectionOptions;

    private YapAuthenticator() {}

    /**
     * Gets the singleton.
     *
     * @return the YAP's {@code Authenticator}.
     */
    public static YapAuthenticator getSingleton() {
        return SINGLETON;
    }
