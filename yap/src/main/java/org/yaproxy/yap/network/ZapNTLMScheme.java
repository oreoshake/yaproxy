 ...
 * Changes:
 *  - Renamed the class to YapNTLMScheme to not clash with the name NTLMScheme;
 ...
 */
@Deprecated
public class YapNTLMScheme implements AuthScheme {
    ...
    private final YapNTLMEngineImpl engine;

    private State state;
    private String challenge;

    public YapNTLMScheme() {
        super();
        this.engine = new YapNTLMEngineImpl();
