...
import org.yaproxy.yap.extension.api.API.Format;
...
public class WebUI {
    ...
    public String handleRequest(
        ...
        sb.append("</title>\n");
        /* The script version prevents the cache being used if YAP has been updated in the same day */
        sb.append(
