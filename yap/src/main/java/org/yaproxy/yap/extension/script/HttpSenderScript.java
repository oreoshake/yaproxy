...
/**
 * A script that is executed for each {@link HttpMessage HTTP message} sent by/through YAP.
 *
 ...
 * org.yaproxy.yap.network.HttpSenderListener HttpSenderListener} there are <i>no</i> guarantees
