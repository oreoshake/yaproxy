...
public class SpiderScanController implements ScanController<SpiderScan> {
    ...
    public int startScan(String name, Target target, User user, Object[] contextSpecificObjects) {
        ...
        try {
            ...
            org.yaproxy.yap.spider.SpiderParam spiderParams = extension.getSpiderParam();
            List<org.yaproxy.yap.spider.parser.SpiderParser> customSpiderParsers =
                    new ArrayList<>();
            List<org.yaproxy.yap.spider.filters.FetchFilter> customFetchFilters = new ArrayList<>();
            List<org.yaproxy.yap.spider.filters.ParseFilter> customParseFilters = new ArrayList<>();
            URI startUri = null;

            if (contextSpecificObjects != null) {
                for (Object obj : contextSpecificObjects) {
                    if (obj instanceof org.yaproxy.yap.spider.SpiderParam) {
                        log.debug("Setting custom spider params");
                        spiderParams = (org.yaproxy.yap.spider.SpiderParam) obj;
                    } else if (obj instanceof org.yaproxy.yap.spider.parser.SpiderParser) {
                        customSpiderParsers.add((org.yaproxy.yap.spider.parser.SpiderParser) obj);
                    } else if (obj instanceof org.yaproxy.yap.spider.filters.FetchFilter) {
                        customFetchFilters.add((org.yaproxy.yap.spider.filters.FetchFilter) obj);
                    } else if (obj instanceof org.yaproxy.yap.spider.filters.ParseFilter) {
                        customParseFilters.add((org.yaproxy.yap.spider.filters.ParseFilter) obj);
