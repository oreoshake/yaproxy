 ...
 * </ul>
 *
 * @see org.yaproxy.yap.extension.brk.BreakPanelToolbarFactory#getBtnDrop()
 */
public class BreakpointsOptionsPanel extends AbstractParamPanel {
    ...
    private YapTextField javascriptUrlRegexField = null;
    private YapTextField cssAndFontsUrlRegexField = null;
    private YapTextField multimediaUrlRegexField = null;
    ...
    private YapTextField getJavascriptUrlRegexField() {
        if (javascriptUrlRegexField == null) {
            javascriptUrlRegexField = new YapTextField();
        }
        return javascriptUrlRegexField;
    }

    private YapTextField getCssAndFontsUrlRegexField() {
        if (cssAndFontsUrlRegexField == null) {
            cssAndFontsUrlRegexField = new YapTextField();
        }
        return cssAndFontsUrlRegexField;
    }

    private YapTextField getMultimediaUrlRegexField() {
        if (multimediaUrlRegexField == null) {
            multimediaUrlRegexField = new YapTextField();
        }
