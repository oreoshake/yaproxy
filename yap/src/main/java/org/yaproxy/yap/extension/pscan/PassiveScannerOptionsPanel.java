...
class PassiveScannerOptionsPanel extends AbstractParamPanel {
    ...
    private final YapNumberSpinner passiveScanThreads;
    private final YapNumberSpinner maxAlertsPerRule;
    private final YapNumberSpinner maxBodySizeInBytes;
    ...
    public PassiveScannerOptionsPanel(ExtensionPassiveScan extPassiveScan, I18N messages) {
        ...
        passiveScanThreads = new YapNumberSpinner(1, Constant.getDefaultThreadCount(), 50);
        maxAlertsPerRule = new YapNumberSpinner();
        maxBodySizeInBytes = new YapNumberSpinner();
        ...
        this.add(
                new YapHtmlLabel(messages.getString("pscan.options.main.footer.threadsApply")),
