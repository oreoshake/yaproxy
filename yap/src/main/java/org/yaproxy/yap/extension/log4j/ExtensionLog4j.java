 ...
 */
package org.yaproxy.yap.extension.log4j;
...
public class ExtensionLog4j extends ExtensionAdaptor {
    ...
    private YapMenuItem menuGarbageCollect = null;
    ...
    private YapMenuItem getMenuGarbageCollect() {
        if (menuGarbageCollect == null) {
            menuGarbageCollect = new YapMenuItem("log4j.tools.menu.gc");
    ...
    private static class ResetCounterOnSessionChange implements SessionChangedListener {
        ...
        /** Do not reset the counter if YAP is starting. */
