...
/**
 * A {@code SearchView} that uses a {@link YapBasicSearchNavigatorUI} for its {@code
 * JHelpSearchNavigator}.
 *
 * @since 2.5.0
 */
public class YapSearchView extends SearchView {

    private static final long serialVersionUID = 1L;

    public YapSearchView(HelpSet hs, String name, String label, Hashtable<?, ?> params) {
        super(hs, name, label, params);
    }

    public YapSearchView(
    ...
    public Component createNavigator(HelpModel model) {
        return new JHelpSearchNavigator(this, model) {
            ...
            public String getUIClassID() {
                return "YapHelpSearchNavigatorUI";
            }
        };
    }
}
