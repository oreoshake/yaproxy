...
import org.yaproxy.yap.model.DefaultValueGenerator;
import org.yaproxy.yap.model.ScanController;
...
public class ExtensionSpider extends ExtensionAdaptor
    ...
    private org.yaproxy.yap.spider.SpiderParam params = null;

    private List<org.yaproxy.yap.spider.parser.SpiderParser> customParsers;
    private List<org.yaproxy.yap.spider.filters.FetchFilter> customFetchFilters;
    private List<org.yaproxy.yap.spider.filters.ParseFilter> customParseFilters;
    ...
    private YapMenuItem menuItemCustomScan = null;
     ...
     */
    protected org.yaproxy.yap.spider.SpiderParam getSpiderParam() {
        if (params == null) {
            params = new org.yaproxy.yap.spider.SpiderParam();
        }
        return params;
    }
     ...
     */
    public List<org.yaproxy.yap.spider.parser.SpiderParser> getCustomParsers() {
     ...
     */
    public List<org.yaproxy.yap.spider.filters.FetchFilter> getCustomFetchFilters() {
     ...
     */
    public List<org.yaproxy.yap.spider.filters.ParseFilter> getCustomParseFilters() {
     ...
     *
     * <p>This method should be used to customize the Spider from any other extension of YAP. The
     * parsers added will be loaded whenever starting any scan.
     *
     * @param parser the parser
     * @throws IllegalArgumentException if the given parameter is {@code null}.
     * @see #removeCustomParser(org.yaproxy.yap.spider.parser.SpiderParser)
     */
    public void addCustomParser(org.yaproxy.yap.spider.parser.SpiderParser parser) {
     ...
     * @throws IllegalArgumentException if the given parameter is {@code null}.
     * @since 2.6.0
     * @see #addCustomParser(org.yaproxy.yap.spider.parser.SpiderParser)
     */
    public void removeCustomParser(org.yaproxy.yap.spider.parser.SpiderParser parser) {
        validateParameterNonNull(parser, "parser");
     ...
     * @throws IllegalArgumentException if the given parameter is {@code null}.
     * @see #removeCustomFetchFilter(org.yaproxy.yap.spider.filters.FetchFilter)
     */
    public void addCustomFetchFilter(org.yaproxy.yap.spider.filters.FetchFilter filter) {
     ...
     * @throws IllegalArgumentException if the given parameter is {@code null}.
     * @since 2.6.0
     * @see #addCustomFetchFilter(org.yaproxy.yap.spider.filters.FetchFilter)
     */
    public void removeCustomFetchFilter(org.yaproxy.yap.spider.filters.FetchFilter filter) {
        validateParameterNonNull(filter, "filter");
     ...
     * @param filter the filter
     * @throws IllegalArgumentException if the given parameter is {@code null}.
     * @see #removeCustomParseFilter(org.yaproxy.yap.spider.filters.ParseFilter)
     */
    public void addCustomParseFilter(org.yaproxy.yap.spider.filters.ParseFilter filter) {
        validateParameterNonNull(filter, "filter");
     ...
     * @throws IllegalArgumentException if the given parameter is {@code null}.
     * @since 2.6.0
     * @see #addCustomParseFilter(org.yaproxy.yap.spider.filters.ParseFilter)
     */
    public void removeCustomParseFilter(org.yaproxy.yap.spider.filters.ParseFilter filter) {
        validateParameterNonNull(filter, "filter");
    ...
    private String createDisplayName(Target target, Object[] customConfigurations) {
        org.yaproxy.yap.spider.filters.HttpPrefixFetchFilter subtreeFecthFilter =
     ...
     */
    private org.yaproxy.yap.spider.filters.HttpPrefixFetchFilter getUriPrefixFecthFilter(
            Object[] customConfigurations) {
        if (customConfigurations != null) {
            for (Object customConfiguration : customConfigurations) {
                if (customConfiguration
                        instanceof org.yaproxy.yap.spider.filters.HttpPrefixFetchFilter) {
                    return (org.yaproxy.yap.spider.filters.HttpPrefixFetchFilter)
                            customConfiguration;
                }
            }
        }
    ...
    private YapMenuItem getMenuItemCustomScan() {
