 ...
 */
package org.yaproxy.yap.extension.option;
...
public class SocksProxyPanel extends JPanel {
    ...
    private final YapTextField hostTextField;
    private final YapPortNumberSpinner portNumberSpinner;
    ...
    private final YapTextField usernameTextField;
    ...
    public SocksProxyPanel() {
        ...
        hostTextField = new YapTextField();
        ...
        usernameTextField = new YapTextField();
    ...
    private void setSelectedVersion(org.yaproxy.yap.network.SocksProxy.Version version) {
        switch (version) {
            case SOCKS4a:
                version4RadioButton.setSelected(true);
                break;
    ...
    private org.yaproxy.yap.network.SocksProxy.Version getSelectedVersion() {
        if (version4RadioButton.isSelected()) {
            return org.yaproxy.yap.network.SocksProxy.Version.SOCKS4a;
        }
        return org.yaproxy.yap.network.SocksProxy.Version.SOCKS5;
    }
    ...
    public void initParam(org.parosproxy.paros.network.ConnectionParam options) {
        ...
        org.yaproxy.yap.network.SocksProxy socksProxy = options.getSocksProxy();
    ...
    public void saveParam(org.parosproxy.paros.network.ConnectionParam options) {
        ...
        org.yaproxy.yap.network.SocksProxy oldSocksProxy = options.getSocksProxy();
