...
import org.yaproxy.yap.utils.NetworkUtils;
...
public class OptionsCallbackPanel extends AbstractParamPanel {
    ...
    private YapTextField testURL = null;
    private JCheckBox randomPort = null;
    private YapPortNumberSpinner spinnerPort = null;
    ...
    private YapTextField getTestURL() {
        if (testURL == null) {
            testURL = new YapTextField();
    ...
    private YapPortNumberSpinner getSpinnerPort() {
        if (spinnerPort == null) {
            spinnerPort = new YapPortNumberSpinner(0);
        }
        return spinnerPort;
    }
