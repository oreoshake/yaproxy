...
import org.yaproxy.yap.extension.log4j.ExtensionLog4j;
import org.yaproxy.yap.extension.ruleconfig.ExtensionRuleConfig;
...
public class AttackModeScanner implements EventConsumer {
    ...
    public AttackModeScanner(ExtensionActiveScan extension) {
        ...
        YAP.getEventBus().registerConsumer(this, SiteMapEventPublisher.class.getCanonicalName());
    ...
    public void start() {
        ...
        Thread t = new Thread(attackModeThread, "YAP-AttackMode");
        t.setDaemon(true);
        t.start();
    }
