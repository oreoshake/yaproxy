...
import org.yaproxy.yap.view.AbstractMultipleOptionsBaseTablePanel;
...
public class OptionsCheckForUpdatesPanel extends AbstractParamPanel {
    ...
    private JPanel getPanelMisc() {
        if (panelMisc == null) {
            ...
            JPanel yapPanel = new JPanel();
            yapPanel.setLayout(new GridBagLayout());
            yapPanel.setBorder(
                    BorderFactory.createTitledBorder(
                            null,
                            Constant.messages.getString("cfu.options.yap.border"),
                            TitledBorder.DEFAULT_JUSTIFICATION,
                            javax.swing.border.TitledBorder.DEFAULT_POSITION,
                            FontUtils.getFont(FontUtils.Size.standard)));

            yapPanel.add(getChkDownloadNewRelease(), LayoutHelper.getGBC(0, 1, 1, 1.0D));
            ...
            panelMisc.add(yapPanel, LayoutHelper.getGBC(0, 1, 1, 1.0D));
