 ...
 *
 * Copyright 2023 The YAP Development Team
 *
...
public class PopupMenuJumpTo extends PopupMenuItemHistoryReferenceContainer {
    ...
    private static YapNumberSpinner idSpinner = new YapNumberSpinner(1, 1, Integer.MAX_VALUE);
    ...
    public PopupMenuJumpTo(ExtensionHistory extension) {
        ...
        String jumpTo = "yap.history.jumpto";
