...
public class ExtensionAPI extends ExtensionAdaptor {
     ...
     *     HTTPS).
     */
    @Deprecated public static final String API_URL = "http://yap/";

    private OptionsApiPanel optionsApiPanel = null;
    private YapMenuItem menuAPI = null;
    ...
    private YapMenuItem getMenuAPI() {
        if (menuAPI == null) {
            menuAPI = new YapMenuItem("api.menu.tools.url");
