...
class DialogAddDomainAlwaysInScope extends AbstractFormDialog {
    ...
    private YapTextField domainTextField;
    private JCheckBox regexCheckBox;
    private JCheckBox enabledCheckBox;

    protected org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher domainAlwaysInScope;
    ...
    protected boolean validateFields() {
        if (getRegexCheckBox().isSelected()) {
            try {
                org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher.createPattern(
    ...
    protected void performAction() {
        ...
        if (getRegexCheckBox().isSelected()) {
            Pattern pattern =
                    org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher.createPattern(value);
            domainAlwaysInScope = new org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher(pattern);
        } else {
            domainAlwaysInScope = new org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher(value);
        }
    ...
    public org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher getDomainAlwaysInScope() {
        return domainAlwaysInScope;
    }

    protected YapTextField getDomainTextField() {
        if (domainTextField == null) {
            domainTextField = new YapTextField(25);
            domainTextField
                    .getDocument()
