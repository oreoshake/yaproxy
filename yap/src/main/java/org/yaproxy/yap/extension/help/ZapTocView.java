...
public class YapTocView extends TOCView {

    private static final long serialVersionUID = 8473218435547565830L;

    public YapTocView(HelpSet hs, String name, String label, Hashtable<?, ?> params) {
     ...
     * creates {@code YapTocItem}s (instead of {@code TOCItem}s).
     *
    ...
    private static class TreeItemFactoryImpl extends DefaultTOCFactory {
        ...
        public TreeItem createItem(
            ...
            YapTocItem item = new YapTocItem(mapID, imageMapID, hs, locale, tocid);
            if (text != null) {
                item.setName(text);
            }
