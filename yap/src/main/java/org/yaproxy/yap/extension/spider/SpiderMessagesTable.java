...
class SpiderMessagesTable extends HistoryReferencesTable {
    ...
    private static class ProcessedCellItemIconHighlighter extends AbstractHighlighter {
        ...
        protected Component doHighlight(Component component, ComponentAdapter adapter) {
            org.yaproxy.yap.extension.spider.SpiderMessagesTableModel.ProcessedCellItem cell =
                    (org.yaproxy.yap.extension.spider.SpiderMessagesTableModel.ProcessedCellItem)
