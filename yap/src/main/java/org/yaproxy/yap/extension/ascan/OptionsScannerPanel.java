...
public class OptionsScannerPanel extends AbstractParamPanel {
    ...
    private YapNumberSpinner spinnerThreadsPerHost = null;
    private YapNumberSpinner spinnerDelayInMs = null;
    private YapNumberSpinner spinnerMaxRuleDuration = null;
    private YapNumberSpinner spinnerMaxScanDuration = null;
    private YapNumberSpinner maxAlertsPerRule;
    private YapNumberSpinner spinnerMaxResultsList = null;
    ...
    private YapNumberSpinner spinnerMaxChartTime = null;
    ...
    private JPanel getPanelScanner() {
        if (panelScanner == null) {
            ...
            maxAlertsPerRule = new YapNumberSpinner();
            JLabel label =
    ...
    private YapNumberSpinner getSpinnerThreadsPerHost() {
        if (spinnerThreadsPerHost == null) {
            spinnerThreadsPerHost =
                    new YapNumberSpinner(1, Constant.getDefaultThreadCount(), Integer.MAX_VALUE);
        }
        return spinnerThreadsPerHost;
    }

    private YapNumberSpinner getSpinnerDelayInMs() {
        if (spinnerDelayInMs == null) {
            spinnerDelayInMs = new YapNumberSpinner(0, 0, Integer.MAX_VALUE);
        }
    ...
    private YapNumberSpinner getSpinnerMaxResultsList() {
        if (spinnerMaxResultsList == null) {
            spinnerMaxResultsList = new YapNumberSpinner();
    ...
    private YapNumberSpinner getSpinnerMaxRuleDuration() {
        if (spinnerMaxRuleDuration == null) {
            spinnerMaxRuleDuration = new YapNumberSpinner();
        }
        return spinnerMaxRuleDuration;
    }

    private YapNumberSpinner getSpinnerMaxScanDuration() {
        if (spinnerMaxScanDuration == null) {
            spinnerMaxScanDuration = new YapNumberSpinner();
        }
        return spinnerMaxScanDuration;
    }

    private YapNumberSpinner getSpinnerMaxChartTime() {
        if (spinnerMaxChartTime == null) {
            spinnerMaxChartTime = new YapNumberSpinner();
