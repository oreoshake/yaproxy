...
public class OptionsStatsPanel extends AbstractParamPanel {
    ...
    private YapTextField statsdHostField;
    private YapPortNumberSpinner statsdPortField;
    private YapTextField statsdPrefixField;
    ...
    private YapTextField getStatsdHostField() {
        if (statsdHostField == null) {
            statsdHostField = new YapTextField();
        }
        return statsdHostField;
    }

    private YapPortNumberSpinner getStatsdPortField() {
        if (statsdPortField == null) {
            statsdPortField = new YapPortNumberSpinner(0);
        }
        return statsdPortField;
    }

    private YapTextField getStatsdPrefixField() {
        if (statsdPrefixField == null) {
            statsdPrefixField = new YapTextField();
        }
