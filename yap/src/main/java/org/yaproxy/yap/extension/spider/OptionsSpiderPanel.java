...
import org.yaproxy.yap.view.PositiveValuesSlider;
...
public class OptionsSpiderPanel extends AbstractParamPanel {
    ...
    private YapNumberSpinner durationNumberSpinner = null;
    private YapNumberSpinner maxChildrenNumberSpinner;
    private YapNumberSpinner maxParseSizeBytesNumberSpinner;
    ...
    private YapTextArea irrelevantUrlParameters;

    private JComboBox<org.yaproxy.yap.spider.SpiderParam.HandleParametersOption> handleParameters =
            null;
    ...
    private JPanel getPanelSpider() {
        if (panelSpider == null) {
            ...
            YapTextArea irrelevantUrlParameters = getIrrelevantUrlParameters();
            JLabel label =
                    new JLabel(
    ...
    public void initParam(Object obj) {
        ...
        org.yaproxy.yap.spider.SpiderParam param =
                options.getParamSet(org.yaproxy.yap.spider.SpiderParam.class);
    ...
    public void saveParam(Object obj) throws Exception {
        ...
        param.setHandleParameters(
                (org.yaproxy.yap.spider.SpiderParam.HandleParametersOption)
    ...
    private YapNumberSpinner getDurationNumberSpinner() {
        if (durationNumberSpinner == null) {
            durationNumberSpinner = new YapNumberSpinner(0, 0, Integer.MAX_VALUE);
        }
        return durationNumberSpinner;
    }

    private YapNumberSpinner getMaxChildrenNumberSpinner() {
        if (maxChildrenNumberSpinner == null) {
            maxChildrenNumberSpinner = new YapNumberSpinner(0, 0, Integer.MAX_VALUE);
        }
        return maxChildrenNumberSpinner;
    }

    private YapNumberSpinner getMaxParseSizeBytesNumberSpinner() {
        if (maxParseSizeBytesNumberSpinner == null) {
            maxParseSizeBytesNumberSpinner = new YapNumberSpinner(0, 0, Integer.MAX_VALUE);
        }
    ...
    private JComboBox<org.yaproxy.yap.spider.SpiderParam.HandleParametersOption>
            getComboHandleParameters() {
        if (handleParameters == null) {
            handleParameters =
                    new JComboBox<>(
                            new org.yaproxy.yap.spider.SpiderParam.HandleParametersOption[] {
                                org.yaproxy.yap.spider.SpiderParam.HandleParametersOption.USE_ALL,
                                org.yaproxy.yap.spider.SpiderParam.HandleParametersOption
                                        .IGNORE_VALUE,
                                org.yaproxy.yap.spider.SpiderParam.HandleParametersOption
                                        .IGNORE_COMPLETELY
    ...
    private YapTextArea getIrrelevantUrlParameters() {
        if (irrelevantUrlParameters == null) {
            irrelevantUrlParameters = new YapTextArea();
    ...
    private static class HandleParametersOptionRenderer extends BasicComboBoxRenderer {
        ...
        public Component getListCellRendererComponent(
            ...
            if (value != null) {
                setBorder(BORDER);
                org.yaproxy.yap.spider.SpiderParam.HandleParametersOption item =
                        (org.yaproxy.yap.spider.SpiderParam.HandleParametersOption) value;
    ...
    private static class DomainsAlwaysInScopeMultipleOptionsPanel
            extends AbstractMultipleOptionsTablePanel<
                    org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher> {
        ...
        @Override
        public org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher showAddDialogue() {
            if (addDialog == null) {
                addDialog =
            ...
            org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher hostAuthentication =
        ...
        @Override
        public org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher showModifyDialogue(
                org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher e) {
            ...
            org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher excludedDomain =
        ...
        @Override
        public boolean showRemoveDialogue(org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher e) {
