 ...
 */
package org.yaproxy.yap.extension.globalexcludeurl;
...
class DialogAddToken extends AbstractFormDialog {
    ...
    private YapTextField regexTextField;
    private JCheckBox enabledCheckBox;
    private YapTextField descTextField;
    ...
    protected YapTextField getRegexTextField() {
        if (regexTextField == null) {
            regexTextField = new YapTextField(25);
            regexTextField
                    .getDocument()
                    .addDocumentListener(
    ...
    protected YapTextField getDescTextField() {
        if (descTextField == null) {
            descTextField = new YapTextField(25);
            descTextField
                    .getDocument()
                    .addDocumentListener(
                            new DocumentListener() {
