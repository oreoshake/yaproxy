 ...
 */
package org.yaproxy.yap.extension.brk;
...
import org.yaproxy.yap.extension.brk.impl.http.HttpBreakpointManagementDaemonImpl;
import org.yaproxy.yap.extension.brk.impl.http.HttpBreakpointMessage;
import org.yaproxy.yap.extension.brk.impl.http.HttpBreakpointMessage.Location;
import org.yaproxy.yap.extension.brk.impl.http.HttpBreakpointMessage.Match;
import org.yaproxy.yap.extension.brk.impl.http.HttpBreakpointsUiManagerInterface;
import org.yaproxy.yap.extension.brk.impl.http.ProxyListenerBreak;
...
public class ExtensionBreak extends ExtensionAdaptor
    ...
    private YapMenuItem menuBreakOnRequests = null;
    private YapMenuItem menuBreakOnResponses = null;
    private YapMenuItem menuStep = null;
    private YapMenuItem menuContinue = null;
    private YapMenuItem menuDrop = null;
    private YapMenuItem menuHttpBreakpoint = null;
    ...
    private YapMenuItem getMenuToggleBreakOnRequests() {
    ...
    private YapMenuItem getMenuToggleBreakOnResponses() {
    ...
    private YapMenuItem getMenuStep() {
        if (menuStep == null) {
            menuStep =
                    new YapMenuItem(
                            "menu.tools.brk.step",
    ...
    private YapMenuItem getMenuContinue() {
    ...
    private YapMenuItem getMenuDrop() {
        if (menuDrop == null) {
            menuDrop =
                    new YapMenuItem(
                            "menu.tools.brk.drop",
    ...
    private YapMenuItem getMenuAddHttpBreakpoint() {
