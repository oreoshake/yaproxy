 ...
 * @since 2.5.0
 */
public class YapBasicSearchNavigatorUI extends BasicSearchNavigatorUI {

    private static final Logger LOGGER = LogManager.getLogger(YapBasicSearchNavigatorUI.class);

    public YapBasicSearchNavigatorUI(JHelpSearchNavigator b) {
        super(b);
    }
    ...
    public static ComponentUI createUI(JComponent x) {
        return new YapBasicSearchNavigatorUI((JHelpSearchNavigator) x);
    }
}
