...
import org.yaproxy.yap.extension.pscan.ExtensionPassiveScan;
import org.yaproxy.yap.extension.pscan.PluginPassiveScanner;
import org.yaproxy.yap.model.Vulnerabilities;
import org.yaproxy.yap.model.Vulnerability;
...
public class AlertViewPanel extends AbstractPanel {
    ...
    private YapTextArea defaultOutput = null;
    private JXPanel alertDisplay = null;
    private CardLayout cardLayout = null;

    private YapLabel alertUrl = null;
    private YapLabel alertName = null;
    private JLabel alertRisk = null;
    private JLabel alertConfidence = null;
    private YapLabel alertParam = null;
    private YapLabel alertAttack = null;
    private YapLabel alertEvidence = null;
    private YapLabel alertInputVector;
    private YapTextArea alertDescription = null;
    private YapTextArea alertOtherInfo = null;
    private YapTextArea alertSolution = null;
    private YapTextArea alertReference = null;
    private YapTable alertTagsTable = null;
    private AlertTagsTableModel alertTagsTableModel = null;
    private YapLabel alertCweId = null;
    private YapLabel alertWascId = null;
    private YapLabel alertSource;
    private JLabel alertRefLabel;
    private YapLabel alertRef;
    ...
    private YapTextField alertEditAttack = null;
    private YapTextField alertEditEvidence = null;
    private DefaultComboBoxModel<String> nameListModel = null;
    private DefaultComboBoxModel<String> paramListModel = null;
    private YapNumberSpinner alertEditCweId = null;
    private YapNumberSpinner alertEditWascId = null;
    ...
    private YapTextArea createYapTextArea() {
        YapTextArea YapTextArea = new YapTextArea(3, 30);
        YapTextArea.setLineWrap(true);
        YapTextArea.setWrapStyleWord(true);
        YapTextArea.setEditable(editable);
        return YapTextArea;
    }
    ...
    private JPanel getAlertDisplay() {
        if (alertDisplay == null) {
            ...
            alertEditAttack = new YapTextField();
            ...
            alertOtherInfo = createYapTextArea();
            JScrollPane otherSp =
            ...
            alertSolution = createYapTextArea();
            ...
            alertReference = createYapTextArea();
    ...
    private JPanel createAlertTagsPanel() {
        ...
        alertTagsTable = new YapTable(alertTagsTableModel);
    ...
    private YapTextArea getDefaultOutput() {
        if (defaultOutput == null) {
            defaultOutput = new YapTextArea();
    ...
    private static void setTextDiscardEditsAndInitCaretPosition(YapTextArea textArea, String text) {
