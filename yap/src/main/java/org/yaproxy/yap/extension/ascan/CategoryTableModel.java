 ...
 */
// YAP: 2012/03/14 Changed to use the internationalised strings.
// YAP: 2012/04/25 Changed to use the method Boolean.valueOf.
// YAP: 2013/01/27 Changed to only notify the listeners if the value was really changed.
// YAP: 2013/03/03 Issue 546: Remove all template Javadoc comments
// YAP: 2013/11/28 Issue 923: Allow individual rule thresholds and strengths to be set via GUI
// YAP: 2014/05/20 Issue 377: Unfulfilled dependencies hang the active scan
// YAP: 2014/11/19 Issue 1412: Manage scan policies
// YAP: 2016/04/04 Use StatusUI in scanners' dialogues
// YAP: 2017/06/05 Return AlertThreshold.OFF if the plugin is disabled.
// YAP: 2018/01/30 Do not rely on default locale for upper/lower case conversions (when locale is
// not important).
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2022/08/04 Ensure scan rule names are non-blank (Issue 7228)
