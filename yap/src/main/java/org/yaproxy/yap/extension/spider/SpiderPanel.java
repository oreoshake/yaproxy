...
import org.yaproxy.yap.view.ScanPanel2;
import org.yaproxy.yap.view.YapTable;
import org.yaproxy.yap.view.table.decorator.AbstractTableCellItemIconHighlighter;
...
public class SpiderPanel extends ScanPanel2<SpiderScan, ScanController<SpiderScan>>
     ...
     *
     * @since 2.5.0
     * @see org.yaproxy.yap.view.messagecontainer.http.HttpMessageContainer
     */
     ...
     */
    private YapTable addedNodesTable;
     ...
     */
    public SpiderPanel(
            ExtensionSpider extension, org.yaproxy.yap.spider.SpiderParam spiderScanParam) {
        super(
                "spider",
    ...
    private JXTable getUrlsTable() {
        if (urlsTable == null) {
            ...
            urlsTable = new YapTable(EMPTY_URLS_TABLE_MODEL);
    ...
    private JXTable getAddedNodesTable() {
        if (addedNodesTable == null) {
            // Create the table with a default, empty TableModel and the proper settings
            addedNodesTable = new YapTable(EMPTY_URLS_NO_FLAGS_TABLE_MODEL);
