 ...
 */
package org.yaproxy.yap.extension.lang;
...
public class OptionsLangPanel extends AbstractParamPanel {
    ...
    private YapTextField fileTextField = null;
    ...
    private JPanel getPanelLang() {
        if (panelLang == null) {
            ...
            restartLabel =
                    new YapHtmlLabel(Constant.messages.getString("options.lang.label.restart"));
    ...
    private YapTextField getFileTextField() {
                    ...
                    new DocumentListener() {
                        ...
                        private void updated(DocumentEvent e) {
                            try {
                                ...
                                importButton.setEnabled(inputString.endsWith(".yaplang"));
