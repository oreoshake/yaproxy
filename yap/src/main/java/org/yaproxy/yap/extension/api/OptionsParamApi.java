...
public class OptionsParamApi extends AbstractParam {
    ...
    /**
     * Add a callback which persists over YAP restarts
     *
    ...
    /**
     * Remove a callback which persists over YAP restarts
     *
    ...
    /**
     * Returns a map of persistent callbacks (which persist over YAP restarts)
     *
