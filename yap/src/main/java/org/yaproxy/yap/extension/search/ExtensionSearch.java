...
public class ExtensionSearch extends ExtensionAdaptor {
    ...
    private YapMenuItem menuItemSearch = null;
    private YapMenuItem menuItemNext = null;
    private YapMenuItem menuItemPrev = null;
    ...
    private YapMenuItem getMenuItemSearch() {
    ...
    private YapMenuItem getMenuItemNext() {
    ...
    private YapMenuItem getMenuItemPrev() {
