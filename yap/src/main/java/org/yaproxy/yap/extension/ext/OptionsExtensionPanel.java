...
public class OptionsExtensionPanel extends AbstractParamPanel {
    ...
    private YapTable tableExt = null;
    private JScrollPane jScrollPane = null;
    private JPanel detailsPane = null;
    private YapLabel extName = new YapLabel();
    private JLabel addOnNameLabel = new JLabel();
    private YapLabel addOnName = new YapLabel();
    private YapLabel extAuthor = new YapLabel();
    private YapLabel extURL = new YapLabel();
    ...
    public OptionsExtensionPanel(ExtensionExtension ext) {
        ...
        this.add(new YapHtmlLabel(Constant.messages.getString("options.ext.label.enable")), gbc);
     ...
     */
    private YapTable getTableExtension() {
        if (tableExt == null) {
            tableExt =
                    new YapTable() {
