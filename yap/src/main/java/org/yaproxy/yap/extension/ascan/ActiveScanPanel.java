...
public class ActiveScanPanel extends ScanPanel2<ActiveScan, ScanController<ActiveScan>>
    ...
    private YapTable filterMessageTable;
    ...
    private TableExportButton<YapTable> exportButton;
    ...
    private TableExportButton<YapTable> getExportButton() {
    ...
    private YapTable getFilterMessageTable() {
        if (filterMessageTable == null) {
            this.filterMessageTable = new YapTable(EMPTY_FILTER_MESSAGE_MODEL);
