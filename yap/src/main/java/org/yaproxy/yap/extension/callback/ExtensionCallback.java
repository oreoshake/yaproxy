 ...
 */
package org.yaproxy.yap.extension.callback;
...
public class ExtensionCallback extends ExtensionAdaptor
    ...
    private static final String TEST_PREFIX = "YapTest";
    ...
    private org.yaproxy.yap.extension.callback.ui.CallbackPanel callbackPanel;

    public ExtensionCallback() {
        proxyServer = new org.parosproxy.paros.core.proxy.ProxyServer("YAP-CallbackServer");
    ...
    private org.yaproxy.yap.extension.callback.ui.CallbackPanel getCallbackPanel() {
        if (callbackPanel == null) {
            callbackPanel = new org.yaproxy.yap.extension.callback.ui.CallbackPanel(this);
        }
    ...
    private void addCallbacksFromDatabaseIntoCallbackPanel(Session session) {
        ...
        try {
            ...
            for (int historyId : historyIds) {
                ...
                org.yaproxy.yap.extension.callback.ui.CallbackRequest request =
                        org.yaproxy.yap.extension.callback.ui.CallbackRequest.create(
                                historyReference);
