...
public class DialogAddAlertTag extends AbstractFormDialog {
    ...
    private YapTextField keyTextField;
    private YapTextArea valueTextArea;
    ...
    protected YapTextField getKeyTextField() {
        if (keyTextField == null) {
            keyTextField = new YapTextField(20);
            keyTextField.getDocument().addDocumentListener(getConfirmButtonValidatorDocListener());
        }
        return keyTextField;
    }

    protected YapTextArea getValueTextArea() {
        if (valueTextArea == null) {
            valueTextArea = new YapTextArea(5, 20);
