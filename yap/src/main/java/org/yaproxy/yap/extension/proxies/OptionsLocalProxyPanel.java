 ...
 */
package org.yaproxy.yap.extension.proxies;
...
public class OptionsLocalProxyPanel extends JPanel {
    ...
    private YapPortNumberSpinner spinnerProxyPort = null;
     ...
     */
    private YapPortNumberSpinner getSpinnerProxyPort() {
        if (spinnerProxyPort == null) {
            // Do not allow invalid port numbers
            spinnerProxyPort = new YapPortNumberSpinner(8080);
        }
