...
// YAP: 2016/01/19 Allow to obtain the ScanPolicy
// YAP: 2016/04/04 Use StatusUI in scanners' dialogues
// YAP: 2016/07/25 Use new AllCategoryTableModel's constructor
// YAP: 2017/06/22 Focus the component that contains validation errors.
...
public class PolicyAllCategoryPanel extends AbstractParamPanel {
    ...
    private YapTextField policyName = null;
    ...
    private YapTextField getPolicyName() {
        if (policyName == null) {
            policyName = new YapTextField();
