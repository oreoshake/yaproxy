...
class DomainsAlwaysInScopeTableModel
    ...
    private List<org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher> domainsInScope =
            new ArrayList<>(5);
    ...
    public List<org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher> getDomainsAlwaysInScope() {
        return domainsInScope;
    }

    public void setDomainsAlwaysInScope(
            List<org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher> domainsInScope) {
        this.domainsInScope = new ArrayList<>(domainsInScope.size());

        for (org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher excludedDomain : domainsInScope) {
            this.domainsInScope.add(
                    new org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher(excludedDomain));
        }
    ...
    @Override
    public List<org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher> getElements() {
        return domainsInScope;
    }
}
