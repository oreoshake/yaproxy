...
public class ScanProgressActionIcon extends JLabel {
    ...
    private static final ImageIcon completedIcon =
            new ImageIcon(YAP.class.getResource("/resource/icon/10/102.png"));
    private static final ImageIcon skippedIcon =
            new ImageIcon(YAP.class.getResource("/resource/icon/10/150.png"));
    private static final ImageIcon skipIcon =
            new ImageIcon(YAP.class.getResource("/resource/icon/16/skip1_16.png"));
    private static final ImageIcon focusedSkipIcon =
            new ImageIcon(YAP.class.getResource("/resource/icon/16/skip1_focused_16.png"));
    private static final ImageIcon pressedSkipIcon =
            new ImageIcon(YAP.class.getResource("/resource/icon/16/skip1_pressed_16.png"));
    private static final ImageIcon SKIP_PENDING_ICON =
            new ImageIcon(YAP.class.getResource("/resource/icon/16/skip-pending.png"));
    private static final ImageIcon SKIP_PENDING_FOCUSED_ICON =
            new ImageIcon(YAP.class.getResource("/resource/icon/16/skip-pending-focused.png"));
    private static final ImageIcon SKIP_PENDING_PRESSED_ICON =
            new ImageIcon(YAP.class.getResource("/resource/icon/16/skip-pending-pressed.png"));
