...
public class BreakPanelToolbarFactory {
    ...
    public JToggleButton getBtnBreakRequest() {
        YapToggleButton btnBreakRequest;

        btnBreakRequest = new YapToggleButton(breakRequestsButtonAction);
    ...
    public JToggleButton getBtnBreakResponse() {
        YapToggleButton btnBreakResponse;

        btnBreakResponse = new YapToggleButton(breakResponsesButtonAction);
    ...
    public JToggleButton getBtnBreakAll() {
        YapToggleButton btnBreakAll;

        btnBreakAll = new YapToggleButton(breakAllButtonAction);
    ...
    public JToggleButton getBtnBreakOnJavaScript() {
        YapToggleButton btnBreakOnJavaScript;

        btnBreakOnJavaScript = new YapToggleButton(setBreakOnJavaScriptAction);
    ...
    public JToggleButton getBtnBreakOnCssAndFonts() {
        YapToggleButton btnBreakOnCssAndFonts;

        btnBreakOnCssAndFonts = new YapToggleButton(setBreakOnCssAndFontsAction);
    ...
    public JToggleButton getBtnBreakOnMultimedia() {
        YapToggleButton btnBreakOnMultimedia;

        btnBreakOnMultimedia = new YapToggleButton(setBreakOnMultimediaAction);
    ...
    public JToggleButton getBtnOnlyBreakOnScope() {
        YapToggleButton btnOnlyBreakOnScope;

        btnOnlyBreakOnScope = new YapToggleButton(setOnlyBreakOnScopeAction);
