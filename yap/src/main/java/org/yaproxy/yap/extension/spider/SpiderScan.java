...
public class SpiderScan
        implements ScanListenner, org.yaproxy.yap.spider.SpiderListener, GenericScanner2 {
    ...
    private static final EnumSet<org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus>
    ...
    private static final EnumSet<org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus>
            FETCH_STATUS_OUT_OF_SCOPE =
                    EnumSet.of(
                            org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus.OUT_OF_SCOPE,
                            org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus.OUT_OF_CONTEXT,
                            org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus.USER_RULES);
     ...
     *
     * @see #foundURI(String, String, org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus)
     ...
     * @see #addMessageToMessagesTableModel(org.yaproxy.yap.spider.SpiderTaskResult)
     */
    ...
    private void addMessageToMessagesTableModel(
            final org.yaproxy.yap.spider.SpiderTaskResult spiderTaskResult) {
