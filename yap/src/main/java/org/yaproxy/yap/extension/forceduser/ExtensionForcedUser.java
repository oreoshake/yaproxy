...
/**
 * The ForcedUser Extension allows YAP user to force all requests that correspond to a given Context
...
public class ExtensionForcedUser extends ExtensionAdaptor
    ...
    private YapToggleButton forcedUserModeButton;
    ...
    private JToggleButton getForcedUserModeToggleButton() {
        if (forcedUserModeButton == null) {
            forcedUserModeButton = new YapToggleButton();
