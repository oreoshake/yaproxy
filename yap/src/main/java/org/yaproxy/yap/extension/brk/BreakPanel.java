...
public class BreakPanel extends AbstractPanel implements BreakpointManagementInterface {
    ...
    private YapToggleButton fixRequestContentLength = null;
    private YapToggleButton fixResponseContentLength = null;
    ...
    private YapToggleButton getRequestButtonFixContentLength() {
    ...
    private YapToggleButton getResponseButtonFixContentLength() {
