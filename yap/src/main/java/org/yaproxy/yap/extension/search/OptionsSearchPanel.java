...
public class OptionsSearchPanel extends AbstractParamPanel {
     ...
     * GUI.
     */
    private YapNumberSpinner numberSpinnerMaxSearchResultsGUI = null;
    ...
    private YapNumberSpinner getNumberSpinnerMaxSearchResultsGUI() {
        if (numberSpinnerMaxSearchResultsGUI == null) {
            numberSpinnerMaxSearchResultsGUI = new YapNumberSpinner();
        }
