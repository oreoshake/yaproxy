...
import org.yaproxy.yap.model.ScanListenner;
import org.yaproxy.yap.model.ScanThread;
 ...
 */
@Deprecated
public class SpiderThread extends ScanThread implements org.yaproxy.yap.spider.SpiderListener {
    ...
    /** The spider. */
    private org.yaproxy.yap.spider.Spider spider = null;

    /** The pending spider listeners which will be added to the Spider as soon at is initialized. */
    private List<org.yaproxy.yap.spider.SpiderListener> pendingSpiderListeners;
    ...
    private org.yaproxy.yap.spider.SpiderParam spiderParams;

    private List<org.yaproxy.yap.spider.parser.SpiderParser> customSpiderParsers = null;

    private List<org.yaproxy.yap.spider.filters.FetchFilter> customFetchFilters = null;

    private List<org.yaproxy.yap.spider.filters.ParseFilter> customParseFilters = null;
    ...
    public SpiderThread(
            ...
            org.yaproxy.yap.spider.SpiderParam spiderParams,
            String site,
        ...
        setName("YAP-SpiderInitThread-" + id);
    }
    ...
    private void startSpider() {
        ...
        spider =
                new org.yaproxy.yap.spider.Spider(
        ...
        for (org.yaproxy.yap.spider.SpiderListener l : pendingSpiderListeners) {
        ...
        if (this.customSpiderParsers != null) {
            for (org.yaproxy.yap.spider.parser.SpiderParser sp : this.customSpiderParsers) {
                spider.addCustomParser(sp);
            }
        }
        if (this.customFetchFilters != null) {
            for (org.yaproxy.yap.spider.filters.FetchFilter ff : this.customFetchFilters) {
                spider.addFetchFilter(ff);
            }
        }
        if (this.customParseFilters != null) {
            for (org.yaproxy.yap.spider.filters.ParseFilter pf : this.customParseFilters) {
    ...
    public void foundURI(
            String uri,
            String method,
            org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus status) {
    ...
    private void addUriToResultsModel(
            final String uri,
            final String method,
            final org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus status) {
        ...
        // Add the new result
        if (status == org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus.VALID) {
            ...
            resultsModel.addScanResult(
                    ...
                    status != org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus.SEED);
        }
    ...
    private String getStatusLabel(org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus status) {
        switch (status) {
            case SEED:
    ...
    @Override
    public void notifySpiderTaskResult(org.yaproxy.yap.spider.SpiderTaskResult spiderTaskResult) {
     ...
     */
    public void addSpiderListener(org.yaproxy.yap.spider.SpiderListener listener) {
        if (spider != null) {
    ...
    public void setCustomSpiderParsers(
            List<org.yaproxy.yap.spider.parser.SpiderParser> customSpiderParsers) {
        this.customSpiderParsers = customSpiderParsers;
    }

    public void setCustomFetchFilters(
            List<org.yaproxy.yap.spider.filters.FetchFilter> customFetchFilters) {
        this.customFetchFilters = customFetchFilters;
    }

    public void setCustomParseFilters(
            List<org.yaproxy.yap.spider.filters.ParseFilter> customParseFilters) {
