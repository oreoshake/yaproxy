...
public class ExtensionDynSSL extends ExtensionAdaptor implements CommandLineListener {
    ...
    public Certificate getRootCA() throws KeyStoreException {
        ...
        return this.getParams()
                .getRootca()
                .getCertificate(
                        org.parosproxy.paros.security.SslCertificateService.YAPROXY_JKS_ALIAS);
    }
    ...
    /**
     * Gets YAPs current Root CA Certificate in X.509 format. Could return {@code null} if there is
     * a problem getting the certificate.
     *
     * @return The X.509 version of YAPs current Root CA certificate.
     * @since 2.7.0
     */
    public X509Certificate getRootCaCertificate() {
        try {
            ...
            logger.error("Couldn't get YAP's Root CA Certificate", e);
            return null;
        }
    }
    ...
    /**
     * Displays a warning dialog, and logs a warning message if YAPs Root CA certificate has
     * expired.
     *
