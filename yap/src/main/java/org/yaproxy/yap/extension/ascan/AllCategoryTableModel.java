 ...
 */
// YAP: 2012/04/25 Added type argument to generic type and changed to use the
// method Boolean.valueOf.
// YAP: 2012/05/03 Moved a statement in the method setValueAt(Object, int , int).
...
// YAP: 2016/07/25 Change constructor's parameter to PluginFactory
// YAP: 2017/06/05 Take into account the enabled state of the plugin when showing the AlertThreshold
// of the category.
