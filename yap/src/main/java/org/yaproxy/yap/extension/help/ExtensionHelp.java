...
import org.yaproxy.yap.utils.LocaleUtils;
...
public class ExtensionHelp extends ExtensionAdaptor {
    ...
    private YapMenuItem menuHelpYap = null;
    ...
    public void initView(ViewDelegate view) {
        ...
        UIManager.getDefaults()
                .put(
                        "YapHelpSearchNavigatorUI",
                        YapBasicSearchNavigatorUI.class.getCanonicalName());
    }
    ...
    public void hook(ExtensionHook extensionHook) {
        ...
        if (getView() != null) {
            extensionHook.getHookMenu().addHelpMenuItem(getMenuHelpYapUserGuide());
    ...
    private void setHelpEnabled(boolean enabled) {
        ...
        if (enabled && findHelpSetUrl() != null) {
            ...
            getMenuHelpYapUserGuide().addActionListener(showHelpActionListener);
            getMenuHelpYapUserGuide().setToolTipText(null);
            getMenuHelpYapUserGuide().setEnabled(true);

            // Enable the top level F1 help key
            hb.enableHelpKey(rootPane, "yap.intro", hs, "javax.help.SecondaryWindow", null);
            ...
            getMenuHelpYapUserGuide().setEnabled(false);
            getMenuHelpYapUserGuide().setToolTipText(toolTipNoHelp);
            getMenuHelpYapUserGuide().removeActionListener(showHelpActionListener);
    ...
    public static void enablePopupHelpKey (Component component, String key) {
    	if (getHelpBroker() != null) {
    		hb.enableHelpKey(component,
    				"yap.intro", hs, "javax.help.SecondaryWindow", null);
    ...
    */
    ...
    private YapMenuItem getMenuHelpYapUserGuide() {
        if (menuHelpYap == null) {
            menuHelpYap =
                    new YapMenuItem(
