...
import org.yaproxy.yap.extension.ascan.PolicyAllCategoryPanel.ScanPolicyChangedEventListener;
...
import org.yaproxy.yap.view.TechnologyTreePanel;
...
public class CustomScanDialog extends StandardFieldsDialog {
    ...
    private YapTextArea requestField = null;
    ...
    private YapTextArea getRequestField() {
        if (requestField == null) {
            requestField = new YapTextArea();
