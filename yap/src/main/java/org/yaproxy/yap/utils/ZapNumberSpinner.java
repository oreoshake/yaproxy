...
public class YapNumberSpinner extends JSpinner {
    ...
    public YapNumberSpinner() {
        this(0, 0, Integer.MAX_VALUE);
    }

    public YapNumberSpinner(int minValue, int defaultValue, int maxValue) {
        ...
        textField.setFormatterFactory(
                new DefaultFormatterFactory(new YapNumberFormatter(minValue, maxValue)));
    ...
    private static class YapNumberFormatter extends NumberFormatter {

        private static final long serialVersionUID = 4888079030453662194L;
        private int minValue;
        private int maxValue;

        public YapNumberFormatter(int minValue, int maxValue) {
            this.minValue = minValue;
            this.maxValue = maxValue;
            ...
            setFormat(new YapNumberFormat(minValue));
        }
    ...
    private static class YapNumberFormat extends Format {
        ...
        public YapNumberFormat(int minValue) {
            this.minValue = minValue;
