...
/**
 * {@code YapTextComponentUndoManager} manages a list of {@code UndoableEdit}s, providing a way to
 ...
 *
 * <p>The {@code YapTextComponentUndoManager} listens to changes to the {@code Document} of the
 * {@code JTextComponent} used with the {@code YapTextComponentUndoManager}, so there is no need to
 ...
 * @see UndoManager
 */
public class YapTextComponentUndoManager extends UndoManager implements PropertyChangeListener {
    ...
    public enum UndoManagerPolicy {
         ...
         * editable.
         *
         * <p>The {@code YapTextComponentUndoManager} listens to the changes in the properties
    ...
    /**
     * Creates a new {@code YapTextComponentUndoManager} with a {@code DEFAULT} policy.
     *
     ...
     */
    public YapTextComponentUndoManager(JTextComponent textComponent) {
        super();
