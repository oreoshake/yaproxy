 ...
 * @since 2.7.0
 */
public final class YapSupportUtils {

    private static final String NEWLINE = System.lineSeparator();

    private YapSupportUtils() {}
    ...
    public static String getYapHomeDirectory() {
    ...
    public static String getAll(boolean formatted) {
        ...
        supportDetailsBuilder.append(getYapHomeDirectory()).append(NEWLINE);
        supportDetailsBuilder.append(getYapInstallDirectory()).append(NEWLINE);
