 ...
 */
public class YapResourceBundleControl extends ResourceBundle.Control {
    ...
    /**
     * Constructs a {@code YapResourceBundleControl} with format {@link
     ...
     * @see #getFormats(String)
     */
    public YapResourceBundleControl() {
        this(Locale.getDefault());
    }

    /**
     * Constructs a {@code YapResourceBundleControl} with the given supported formats and {@link
     * Locale#getDefault() default locale} as fallback locale.
     *
     ...
     * @see #getFormats(String)
     */
    public YapResourceBundleControl(List<String> formats) {
        this(formats, Locale.getDefault());
    }

    /**
     * Constructs a {@code YapResourceBundleControl} with the given fallback locale and with format
     ...
     * @see #getFormats(String)
     */
    public YapResourceBundleControl(Locale fallbackLocale) {
        this(ResourceBundle.Control.FORMAT_PROPERTIES, fallbackLocale);
    }

    /**
     * Constructs a {@code YapResourceBundleControl} with the given supported formats and fallback
     * locale.
     *
     * @param formats the supported formats.
     * @param fallbackLocale the fallback locale, might be {@code null}.
     ...
     * @see #getFormats(String)
     */
    public YapResourceBundleControl(List<String> formats, Locale fallbackLocale) {
        if (formats == null) {
