...
public class I18N {
     ...
     *
     * @see #loadBundledResourceBundle(YapResourceBundleControl)
     */
     ...
     * still, it might be possible that some keys are kept in memory until YAP is shutdown.
     */
     ...
     * @see #loadFsResourceBundle(YapResourceBundleControl)
     */
    ...
    private static URLClassLoader createLangClassLoader() {
        Path langDir = Paths.get(Constant.getYapInstall(), Constant.LANG_DIR);
     ...
     * key itself. This avoids breaking YAP when a resource message is accidentally missing. Use
    ...
    public void setLocale(Locale locale) {
        ...
        this.locale = locale;
        YapResourceBundleControl rbc = new YapResourceBundleControl();
    ...
    private ResourceBundle loadFsResourceBundle(YapResourceBundleControl rbc) {
    ...
    private ResourceBundle loadBundledResourceBundle(YapResourceBundleControl rbc) {
        return loadResourceBundle("org.yaproxy.yap.resources." + Constant.MESSAGES_PREFIX, rbc);
    }

    private ResourceBundle loadResourceBundle(String path, YapResourceBundleControl rbc) {
        return loadResourceBundle(path, getClass().getClassLoader(), rbc);
    }

    private ResourceBundle loadResourceBundle(
            String path, ClassLoader classLoader, YapResourceBundleControl rbc) {
     ...
     * breaking YAP when a resource message is accidentally missing. Use {@link
