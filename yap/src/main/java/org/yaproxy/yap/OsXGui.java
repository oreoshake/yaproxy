...
class OsXGui {
    ...
    public static void setup() {
        ...
        System.setProperty("dock:name", "YAP"); // Broken and unfixed; thanks, Apple
        System.setProperty("com.apple.mrj.application.apple.menu.about.name", "YAP"); // more thx
    ...
    private static void setupJava9Plus(InvocationHandler invocationHandler) throws Throwable {
        ...
        // desktop.setQuitHandler((qe, qr) -> exitYap());
    }

    private static Image createIcon() {
        return Toolkit.getDefaultToolkit()
                .getImage(GuiBootstrap.class.getResource("/resource/yap1024x1024.png"));
    }
