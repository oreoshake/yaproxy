...
import org.yaproxy.yap.view.widgets.ContextSelectComboBox;
...
public abstract class StandardFieldsDialog extends AbstractDialog {
    ...
    public void addTextField(String fieldLabel, String value) {
        addTextComponent(new YapTextField(), fieldLabel, value);
    }
    ...
    public void addTextField(int tabIndex, String fieldLabel, String value) {
        addTextComponent(tabIndex, new YapTextField(), fieldLabel, value);
    }
     ...
     *
     * <p>The edits are discarded after setting the value, if the field is a {@link YapTextField} or
     * {@link YapTextArea}.
     *
    ...
    private static void setTextAndDiscardEdits(JTextComponent field, String value) {
        ...
        field.setText(value);
        if (field instanceof YapTextField) {
            ((YapTextField) field).discardAllEdits();
        } else if (field instanceof YapTextArea) {
            ((YapTextArea) field).discardAllEdits();
        }
    }

    /**
     * Adds a {@link YapLabel} field, with the given label and, optionally, the given value.
     *
    ...
    public void addTextFieldReadOnly(String fieldLabel, String value) {
        addTextComponent(new YapLabel(), fieldLabel, value);
    }

    /**
     * Adds a {@link YapLabel} field, with the given label and, optionally, the given value, to the
    ...
    public void addTextFieldReadOnly(int tabIndex, String fieldLabel, String value) {
        addTextComponent(tabIndex, new YapLabel(), fieldLabel, value);
    }
    ...
    public void addMultilineField(String fieldLabel, String value) {
        validateNotTabbed();
        YapTextArea field = new YapTextArea();
    ...
    public void addNumberField(String fieldLabel, Integer min, Integer max, int value) {
        validateNotTabbed();
        YapNumberSpinner field = new YapNumberSpinner(min, value, max);
        this.addField(fieldLabel, field, field, 0.0D);
    }
    ...
    public void addNodeSelectField(
        ...
        validateNotTabbed();
        final YapTextField text = new YapTextField();
    ...
    private void setTextTarget(YapTextField field, Target target) {
    ...
    public boolean isEmptyField(String fieldLabel) {
        ...
        if (c != null) {
            ...
            } else if (c instanceof YapNumberSpinner) {
                value = ((YapNumberSpinner) c).getValue();
                if ((Integer) value < 0) {
                    value = null;
                }
            } else {
    ...
    public int getIntValue(String fieldLabel) {
        Component c = this.fieldMap.get(fieldLabel);
        if (c != null) {
            if (c instanceof YapNumberSpinner) {
                return ((YapNumberSpinner) c).getValue();
            } else if (c instanceof JComboBox) {
    ...
    public void setFieldValue(String fieldLabel, int value) {
        ...
        if (c != null) {
            if (c instanceof YapNumberSpinner) {
                ((YapNumberSpinner) c).setValue(value);
            } else if (c instanceof JComboBox) {
                ((JComboBox<?>) c).setSelectedItem(value);
            } else {
                handleUnexpectedFieldClass(fieldLabel, c);
