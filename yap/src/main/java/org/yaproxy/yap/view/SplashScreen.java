...
public class SplashScreen extends JFrame {
    ...
    private YapTextArea logPanel = null;
    private YapTextArea tipsPanel = null;
    ...
    public SplashScreen() {
        ...
        setIconImages(DisplayUtils.getYapIconImages());
    ...
    private static ImageIcon createSplashScreenImage() {
        ImageIcon image =
                new ImageIcon(SplashScreen.class.getResource("/resource/yap-splash-screen.png"));
    ...
    private YapTextArea getLogPanel() {
        if (logPanel == null) {
            logPanel = new YapTextArea();
    ...
    private YapTextArea getTipsPanel() {
        if (tipsPanel == null) {
            tipsPanel = new YapTextArea();
