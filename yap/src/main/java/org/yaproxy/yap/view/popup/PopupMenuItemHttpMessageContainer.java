...
import org.yaproxy.yap.extension.alert.AlertPanel;
import org.yaproxy.yap.extension.ascan.ActiveScanPanel;
import org.yaproxy.yap.extension.search.SearchPanel;
...
import org.yaproxy.yap.view.messagecontainer.http.SelectableHttpMessagesContainer;
import org.yaproxy.yap.view.messagecontainer.http.SingleHttpMessageContainer;
    ...
    private static Invoker getInvoker(HttpMessageContainer httpMessageContainer) {
        ...
        switch (httpMessageContainer.getName()) {
            ...
            case SearchPanel.HTTP_MESSAGE_CONTAINER_NAME:
                ...
                break;
            case org.yaproxy.yap.extension.spider.SpiderPanel.HTTP_MESSAGE_CONTAINER_NAME:
