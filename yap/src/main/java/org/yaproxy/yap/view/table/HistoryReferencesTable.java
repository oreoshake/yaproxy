 ...
 */
package org.yaproxy.yap.view.table;
...
import org.yaproxy.yap.utils.PagingTableModel;
...
import org.yaproxy.yap.view.renderer.DateFormatStringValue;
import org.yaproxy.yap.view.renderer.SizeBytesStringValue;
import org.yaproxy.yap.view.renderer.TimeDurationStringValue;
import org.yaproxy.yap.view.table.HistoryReferencesTableModel.Column;
import org.yaproxy.yap.view.table.decorator.AlertRiskTableCellItemIconHighlighter;
import org.yaproxy.yap.view.table.decorator.HrefTypeInfoIconHighlighter;
import org.yaproxy.yap.view.table.decorator.NoteTableCellItemIconHighlighter;
...
public class HistoryReferencesTable extends YapTable {
        ...
        protected SizeBytesStringValue getSizeBytesStringValue() {
            if (sizeBytesStringValue == null) {
                ...
                if (columnControl instanceof YapColumnControlButton) {
                    YapColumnControlButton yapColumnControl =
                            (YapColumnControlButton) columnControl;
                    yapColumnControl.addAction(
