...
public class ContextStructurePanel extends AbstractContextPropertiesPanel {
    ...
    private YapTextField urlKvPairSeparators = null;
    private YapTextField urlKeyValueSeparators = null;
    private YapTextField postKeyValueSeparators = null;
    private YapTextField postKvPairSeparators = null;
    ...
    private YapTextField getUrlKvPairSeparators() {
        if (urlKvPairSeparators == null) {
            urlKvPairSeparators = new YapTextField();
        }
        return urlKvPairSeparators;
    }

    private YapTextField getUrlKeyValueSeparators() {
        if (urlKeyValueSeparators == null) {
            urlKeyValueSeparators = new YapTextField();
        }
        return urlKeyValueSeparators;
    }

    private YapTextField getPostKeyValueSeparators() {
        if (postKeyValueSeparators == null) {
            postKeyValueSeparators = new YapTextField();
        }
        return postKeyValueSeparators;
    }

    private YapTextField getPostKvPairSeparators() {
        if (postKvPairSeparators == null) {
            postKvPairSeparators = new YapTextField();
        }
