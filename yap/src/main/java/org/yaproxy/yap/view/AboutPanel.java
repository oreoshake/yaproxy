...
public class AboutPanel extends JPanel {
    ...
    private static final String COPYRIGHT =
            "Copyright (C) 2010-" + YEAR_TOKEN + " YAP Development Team";
    ...
    private static final String HOMEPAGE =
            "<html><body><p><a>https://www.yaproxy.org/</a></p></body></html>";
    ...
    public AboutPanel() {
        ...
        JLabel lblDisclaimer = new YapHtmlLabel();
        JLabel lblCopyright = new JLabel();
        JLabel lblOtherCopyright = new YapHtmlLabel();
        JLabel lblVersion = new JLabel();
        JLabel lblProgramName = new JLabel();
        JLabel lblCopyrightDetail = new YapHtmlLabel();
        JLabel lblLogo = new JLabel();
        JLabel lblHomepage = new YapHtmlLabel();
        ...
        lblLogo.setText("");
        lblLogo.setIcon(new ImageIcon(AboutPanel.class.getResource("/resource/yap64x64.png")));
