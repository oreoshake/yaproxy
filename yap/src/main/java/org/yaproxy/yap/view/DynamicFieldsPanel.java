...
public class DynamicFieldsPanel extends JPanel {
    ...
    private Map<String, YapTextField> textFields;
    ...
    private void addFieldImpl(String labelText, String fieldName, int fieldIndex) {
        ...
        YapTextField tf = new YapTextField();
    ...
    public Map<String, String> getFieldValues() {
        ...
        for (Entry<String, YapTextField> f : textFields.entrySet())
