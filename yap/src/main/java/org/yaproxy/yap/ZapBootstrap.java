 ...
 */
abstract class YapBootstrap {

    private final CommandLine args;
    private final ControlOverrides controlOverrides;

    public YapBootstrap(CommandLine args) {
        this.args = args;
    ...
    protected static String getStartingMessage() {
        ...
        strBuilder.append(" with home ").append(Constant.getYapHome());
