...
import org.yaproxy.yap.extension.pscan.PassiveScanner;
...
public final class AddOnInstaller {
     ...
     * <yapHome>/addOnData/<addOnId>/<version>/libs/}
     *
     ...
     *
     * <p>The path is built as: {@code <yapHome>/addOnData/<addOnId>/<version>/}
     *
     * @param addOn the add-on.
     ...
     *
     * <p>The path is built as: {@code <yapHome>/addOnData/<addOnId>/<version>/libs/}
     *
     * @param addOn the add-on.
     * @return the path to the directory.
    ...
    private static void installAddOnFiles(
        ...
        for (String name : fileNames) {
            File outfile = new File(Constant.getYapHome(), name);
    ...
    public static boolean uninstallAddOnFiles(
        ...
        for (String name : fileNames) {
            ...
            File file = new File(Constant.getYapHome(), name);
            try {
    ...
    private static void deleteEmptyDirsCreatedForAddOnFiles(File file) {
        ...
        // Delete any empty dirs up to the YAP root dir
        while (currentFile != null && !currentFile.exists()) {
            currentFile = currentFile.getParentFile();
        }
        String root = new File(Constant.getYapHome()).getAbsolutePath();
        while (currentFile != null && currentFile.exists()) {
