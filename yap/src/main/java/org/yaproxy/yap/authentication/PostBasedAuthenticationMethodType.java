...
import org.yaproxy.yap.authentication.UsernamePasswordAuthenticationCredentials.UsernamePasswordAuthenticationCredentialsOptionsPanel;
import org.yaproxy.yap.extension.anticsrf.AntiCsrfToken;
...
import org.yaproxy.yap.extension.authentication.ContextAuthenticationPanel;
...
import org.yaproxy.yap.session.WebSession;
...
import org.yaproxy.yap.view.popup.PopupMenuItemContext;
import org.yaproxy.yap.view.popup.PopupMenuItemSiteNodeContextMenuFactory;
...
public abstract class PostBasedAuthenticationMethodType extends AuthenticationMethodType {
    ...
    public abstract class PostBasedAuthenticationMethod extends AuthenticationMethod {
        ...
        /**
         * The URI of the login page(form). When automatically (re)authenticating, {@code YAP} may
         * need to submit fresh cookie or(and) ACSRF token. {@code YAP} gets those fresh values by
    ...
    public abstract class PostBasedAuthenticationMethodOptionsPanel
        ...
        private YapTextField loginUrlField;

        /**
         * The URI to {@code GET} the login page(form). When automatically (re)authenticating,
         * {@code YAP} may need fresh cookie or(and) ACSRF token value. {@code YAP} gets those fresh
         ...
         * YAP} expects the pen-tester to change this value if both URIs are different.
         */
        private YapTextField loginPageUrlField;

        private YapTextField postDataField;
        ...
        private void initialize() {
            ...
            this.loginUrlField = new YapTextField();
            this.loginPageUrlField = new YapTextField();
            this.postDataField = new YapTextField();
            ...
            this.add(new YapHtmlLabel(AUTH_DESCRIPTION), LayoutHelper.getGBC(0, 8, 2, 1.0d, 0.0d));
