...
public class DefaultFetchFilter extends FetchFilter {
    ...
    private List<org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher> domainsAlwaysInScope =
    ...
    private boolean isDomainAlwaysInScope(String domain) {
        for (org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher domainInScope :
