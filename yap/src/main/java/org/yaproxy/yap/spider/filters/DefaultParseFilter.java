...
public class DefaultParseFilter extends ParseFilter {
    ...
    private final org.yaproxy.yap.spider.SpiderParam params;
    ...
    public DefaultParseFilter() {
        this(
                new org.yaproxy.yap.spider.SpiderParam(),
                new ResourceBundle() {
     ...
     */
    public DefaultParseFilter(
            org.yaproxy.yap.spider.SpiderParam params, ResourceBundle resourceBundle) {
        if (params == null) {
