...
public abstract class SpiderParser {
    ...
    private org.yaproxy.yap.spider.SpiderParam spiderParam;

    public SpiderParser() {}

    public SpiderParser(org.yaproxy.yap.spider.SpiderParam spiderParam) {
        this.spiderParam =
                Objects.requireNonNull(spiderParam, "Parameter spiderParam must not be null.");
    }

    public void setSpiderParam(org.yaproxy.yap.spider.SpiderParam spiderParam) {
    ...
    protected String getCanonicalURL(String localURL, String baseURL) {
        return org.yaproxy.yap.spider.URLCanonicalizer.getCanonicalURL(
