...
public class Spider {
    ...
    private org.yaproxy.yap.spider.filters.DefaultFetchFilter defaultFetchFilter;

    /** The seed list. */
    private LinkedHashSet<URI> seedList;

    /** The extension. */
    private org.yaproxy.yap.extension.spider.ExtensionSpider extension;
    ...
    public Spider(
            String id,
            org.yaproxy.yap.extension.spider.ExtensionSpider extension,
    ...
    private void init() {
        ...
        defaultFetchFilter = new org.yaproxy.yap.spider.filters.DefaultFetchFilter();
        this.addFetchFilter(defaultFetchFilter);

        for (org.yaproxy.yap.spider.filters.FetchFilter filter :
        ...
        controller.setDefaultParseFilter(
                new org.yaproxy.yap.spider.filters.DefaultParseFilter(
                        spiderParam, extension.getMessages()));
        for (org.yaproxy.yap.spider.filters.ParseFilter filter : extension.getCustomParseFilters())
     ...
     */
    protected org.yaproxy.yap.extension.spider.ExtensionSpider getExtensionSpider() {
    ...
    public void start() {
        ...
        this.threadPool =
                Executors.newFixedThreadPool(
                        ...
                        new SpiderThreadFactory("YAP-SpiderThreadPool-" + id + "-thread-"));
     ...
     *
     * @see #seedList
     * @see org.yaproxy.yap.spider.filters.FetchFilter
    ...
    private void fetchFilterSeeds() {
        ...
        for (Iterator<URI> it = seedList.iterator(); it.hasNext(); ) {
            URI seed = it.next();
            for (org.yaproxy.yap.spider.filters.FetchFilter filter : controller.getFetchFilters()) {
                org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus filterReason =
                        filter.checkFilter(seed);
                if (filterReason != org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus.VALID) {
    ...
    public void addCustomParser(org.yaproxy.yap.spider.parser.SpiderParser sp) {
