 ...
 *
 * YAP: Based on work by Yasser Ganjisaffar <lastname at gmail dot com>
...
public final class URLCanonicalizer {
    ...
    private static String createBaseUriWithCleanedPath(
            org.apache.commons.httpclient.URI uri,
            org.yaproxy.yap.spider.SpiderParam.HandleParametersOption handleParameters,
            boolean handleODataParametersVisited)
            throws URIException {
    ...
    private static String cleanODataPath(
        ...
        if (org.yaproxy.yap.spider.SpiderParam.HandleParametersOption.USE_ALL.equals(
                handleParameters)) {
            cleanedPath = path;
        } else {
            ...
            if (matcher.find()) {
                ...
                if (org.yaproxy.yap.spider.SpiderParam.HandleParametersOption.IGNORE_COMPLETELY
