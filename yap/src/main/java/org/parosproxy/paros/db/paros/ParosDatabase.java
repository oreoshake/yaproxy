...
// YAP: 2012/03/15 Changed the parameter's type of the method
...
// YAP: 2012/06/11 Added JavaDoc to the method close(boolean), changed the
// method close(boolean) to call the method close(boolean, boolean), added
// method close(boolean, boolean).
// YAP: 2012/07/16 Removed unused setters.
...
// YAP: 2016/05/24 Add implementation of Database.discardSession(long)
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2020/11/26 Use getLogger().
// YAP: 2021/08/24 Remove the "(non-Javadoc)" comments.
// YAP: 2021/09/27 Added support for Alert Tags.
...
import org.yaproxy.yap.db.TableAlertTag;
import org.yaproxy.yap.db.paros.ParosTableAlertTag;
...
public class ParosDatabase extends AbstractDatabase {
    ...
    // YAP: Added TableSessionUrl.
    private TableSessionUrl tableSessionUrl = null;
    // YAP: Added TableParam.
    ...
    // YAP: Added method. Note: any change made to this method must have the
    // YAP comment as the content was moved from the paros method close(boolean).
    @Override
    public void close(boolean compact, boolean cleanup) {
        ...
        try {
            ...
            // YAP: Changed to catch SQLException instead of Exception.
        } catch (Exception e) {
            // YAP: Changed to log the exception.
            getLogger().error(e.getMessage(), e);
        }
    }
