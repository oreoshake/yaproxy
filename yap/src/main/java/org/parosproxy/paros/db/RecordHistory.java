 ...
 */
// YAP: 2012/03/15 Changed the RecordHistory constructor to receive a byte[]
...
// YAP: 2016/01/26 Fixed findbugs warning (tag field no longer used in history table)
...
public class RecordHistory {
    ...
    // YAP: Added note to RecordHistory constructor
    public RecordHistory(
            int historyId,
            int historyType,
            long sessionId,
