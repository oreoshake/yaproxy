...
// YAP: 2012/08/08 Upgrade to HSQLDB 2.x (introduced TABLE_NAME constant + DbUtils)
// YAP: 2013/07/11 Issue 713: Add CWE and WASC numbers to issues
// YAP: 2014/03/04 Issue 1042: Add ALERT_INDEX to speed up session load
...
// YAP: 2014/08/14 Issue 1283: SQLDataException: data exception: string data,
...
public class ParosTableAlert extends ParosAbstractTable implements TableAlert {
    ...
    protected void reconnect(Connection conn) throws DatabaseException {
        try {
            // YAP: Changed to call the method updateTable(Connection).
            updateTable(conn);
            ...
            // YAP: New prepared statement for updating an alert
            psUpdate =
                    conn.prepareStatement(
                            "UPDATE "
                                    + TABLE_NAME
