...
// YAP: 2012/12/27 Added method addPersistentConnectionListener(...)
// YAP: 2013/01/25 Added method removeProxyListener()
...
// YAP: 2015/01/04 Issue 1387: Unable to change the proxy's port/address if the port/address was
...
// YAP: 2017/03/15 Enable API
// YAP: 2017/11/06 Removed ProxyServerSSL (Issue 3983)
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2019/09/17 Remove irrelevant conditional in stopServer().
// YAP: 2019/12/13 Save the proxy port if it had to be selected during startup (Issue 2016).
    ...
    public boolean startServer() {
        ...
        if (model.getOptionsParam().getProxyParam().isUseReverseProxy()) {
            ...
            if (proxyHost != null) {
                ...
                // YAP: get the proxy IP as set without any check for nullable
