 ...
 */
// YAP: 2012/03/15 Changed the method options to notify all OptionsChangedListener that the
...
// YAP: 2022/02/09 Remove proxy related code.
...
public class MenuToolsControl {
    ...
    // YAP: added ability to select panel
    public void options(String panel) {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            // YAP: Notify all OptionsChangedListener.
