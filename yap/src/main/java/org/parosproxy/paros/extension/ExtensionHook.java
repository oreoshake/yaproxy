...
// YAP: 2012/12/20 Added listener setter for persistentConnectionListenerList.
// YAP: 2013/01/16 Issue 453: Dynamic loading and unloading of add-ons
// YAP: 2013/04/14 Issue 608: Rename the method ExtensionHook.addSiteMapListner to
// addSiteMapListener
...
// YAP: 2014/10/25 Issue 1062: Added scannerhook to be added by extensions.
// YAP: 2016/04/08 Allow to add ContextDataFactory
// YAP: 2016/05/30 Allow to add AddOnInstallationStatusListener
// YAP: 2016/05/30 Issue 2494: YAP Proxy is not showing the HTTP CONNECT Request in history tab
// YAP: 2016/08/18 Allow to add ApiImplementor
// YAP: 2017/07/25 Allow to add HttpSenderListener.
// YAP: 2017/11/23 Add an add method for OverrideMessageProxyListener.
...
// YAP: 2022/06/13 Allow to add HrefTypeInfo.
...
public class ExtensionHook {
    ...
    // YAP: Added support for Scanner Hooks
    ...
    // YAP: get all scannerhooks (used by extensionloader and the scanner)
     ...
     * org.yaproxy.yap.extension.api.API API}.
     *
     ...
     *
     * @param apiImplementor the ApiImplementor that will be added to the YAP API
