...
import org.yaproxy.yap.extension.httppanel.view.impl.models.http.HttpPanelViewModelUtils;
...
public class HttpPanelSender implements org.parosproxy.paros.extension.manualrequest.MessageSender {
    ...
    public void handleSendMessage(Message aMessage) throws IllegalArgumentException, IOException {
        ...
        try {
            ...
            if (!(userObject instanceof org.yaproxy.yap.YapGetMethod)) {
                return;
            }

            org.yaproxy.yap.YapGetMethod method = (org.yaproxy.yap.YapGetMethod) userObject;
    ...
    private void persistAndShowMessage(HttpMessage httpMessage) {
        ...
        try {
            ...
            HistoryReference ref =
                    new HistoryReference(session, HistoryReference.TYPE_YAP_USER, httpMessage);
    ...
    private boolean notifyPersistentConnectionListener(
            ...
            Socket inSocket,
            @SuppressWarnings("deprecation") org.yaproxy.yap.YapGetMethod method) {
