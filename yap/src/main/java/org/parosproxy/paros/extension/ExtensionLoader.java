 ...
 */
// YAP: 2011/12/14 Support for extension dependencies
// YAP: 2012/02/18 Rationalised session handling
// YAP: 2012/03/15 Reflected the change in the name of the method optionsChanged of
...
// YAP: 2012/04/23 Reverted the changes of the method destroyAllExtension(),
...
// YAP: 2012/04/24 Changed the method destroyAllExtension to catch exceptions.
// YAP: 2012/04/25 Added the type argument and removed unnecessary cast.
// YAP: 2012/07/23 Removed parameter from View.getSessionDialog call.
// YAP: 2012/07/29 Issue 43: added sessionScopeChanged event
// YAP: 2012/08/01 Issue 332: added support for Modes
// YAP: 2012/11/30 Issue 425: Added tab index to support quick start tab
// YAP: 2012/12/27 Added hookPersistentConnectionListener() method.
// YAP: 2013/01/16 Issue 453: Dynamic loading and unloading of add-ons
// YAP: 2013/01/25 Added removeExtension(...) method and further helper methods
// to remove listeners, menu items, etc.
// YAP: 2013/01/25 Refactored hookMenu(). Resolved some Checkstyle issues.
// YAP: 2013/01/29 Catch Errors thrown by out of date extensions as well as Exceptions
// YAP: 2013/07/23 Issue 738: Options to hide tabs
// YAP: 2013/11/16 Issue 807: Error while loading YAP when Quick Start Tab is closed
// YAP: 2013/11/16 Issue 845: AbstractPanel added twice to TabbedPanel2 in
// ExtensionLoader#addTabPanel
// YAP: 2013/12/03 Issue 934: Handle files on the command line via extension
// YAP: 2013/12/13 Added support for Full Layout DISPLAY_OPTION_TOP_FULL in the hookView function.
// YAP: 2014/03/23 Issue 1022: Proxy - Allow to override a proxied message
// YAP: 2014/03/23 Issue 1090: Do not add pop up menus if target extension is not enabled
// YAP: 2014/05/20 Issue 1202: Issue with loading addons that did not initialize correctly
// YAP: 2014/08/14 Catch Exceptions thrown by extensions when stopping them
// YAP: 2014/08/14 Issue 1309: NullPointerExceptions during a failed uninstallation of an add-on
// YAP: 2014/10/07 Issue 1357: Hide unused tabs
// YAP: 2014/10/09 Issue 1359: Added info logging for splash screen
// YAP: 2014/10/25 Issue 1062: Added scannerhook to be loaded by an active scanner.
// YAP: 2014/11/11 Issue 1406: Move online menu items to an add-on
// YAP: 2014/11/21 Reviewed foreach loops and commented startup process for splash screen progress
// bar
// YAP: 2015/01/04 Issue 1379: Not all extension's listeners are hooked during add-on installation
// YAP: 2015/01/19 Remove online menus when removeMenu(View, ExtensionHook) is called.
// YAP: 2015/01/19 Issue 1510: New Extension.postInit() method to be called once all extensions
// loaded
// YAP: 2015/02/09 Issue 1525: Introduce a database interface layer to allow for alternative
// implementations
// YAP: 2015/02/10 Issue 1208: Search classes/resources in add-ons declared as dependencies
// YAP: 2015/04/09 Generify Extension.getExtension(Class) to avoid unnecessary casts
// YAP: 2015/09/07 Start GUI on EDT
// YAP: 2016/04/06 Fix layouts' issues
// YAP: 2016/04/08 Hook ContextDataFactory/ContextPanelFactory
// YAP: 2016/05/30 Notification of installation status of the add-ons
// YAP: 2016/05/30 Issue 2494: YAP Proxy is not showing the HTTP CONNECT Request in history tab
// YAP: 2016/08/18 Hook ApiImplementor
// YAP: 2016/11/23 Call postInit() when starting an extension, startLifeCycle(Extension).
// YAP: 2017/02/19 Hook/remove extensions' components to/from the main tool bar.
// YAP: 2017/06/07 Allow to notify of changes in the session's properties (e.g. name, description).
// YAP: 2017/07/25 Hook HttpSenderListener.
// YAP: 2017/10/11 Include add-on in extensions' initialisation errors.
// YAP: 2017/10/31 Add JavaDoc to ExtensionLoader.getExtension(String).
// YAP: 2018/04/25 Allow to add ProxyServer to automatically add/remove proxy related listeners to
// it.
// YAP: 2018/07/18 Tweak logging.
// YAP: 2018/10/05 Get menu/view hooks without initialising them.
// YAP: 2018/10/09 Use managed ExtensionHook when removing extensions.
// YAP: 2019/03/15 Issue 3578: Added Helper options for Import menu
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2019/07/25 Relocate null check to be earlier in hookScannerHook(scan) [LGTM issue].
// YAP: 2019/08/19 Validate menu and main frame in EDT.
// YAP: 2019/09/30 Use instance variable for view checks.
// YAP: 2020/05/14 Hook HttpSenderListener when starting single extension.
// YAP: 2020/08/27 Added support for plugable variants
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2021/04/13 Issue 6536: Stop and destroy extensions being removed.
// YAP: 2021/08/17 Issue 6755: Extension's errors during shutdown prevent YAP to exit.
// YAP: 2021/10/01 Do not initialise view if there's none when starting a single extension.
// YAP: 2022/02/09 Deprecate code related to core proxy, remove code no longer needed.
// YAP: 2022/04/17 Log extension name prior to description when loading.
// YAP: 2022/04/17 Address various SAST (SonarLint) issues.
// YAP: 2022/06/13 Hook HrefTypeInfo.
// YAP: 2022/08/17 Install updates before running other cmdline args.
// YAP: 2022/11/23 Refresh tabs menu when tabs are removed.
// YAP: 2023/01/10 Tidy up logger.
// YAP: 2023/04/28 Deprecate Proxy and ProxyServer related methods.
...
import org.yaproxy.yap.PersistentConnectionListener;
import org.yaproxy.yap.control.AddOn;
import org.yaproxy.yap.extension.AddOnInstallationStatusListener;
import org.yaproxy.yap.extension.AddonFilesChangedListener;
import org.yaproxy.yap.extension.api.API;
import org.yaproxy.yap.extension.api.ApiImplementor;
import org.yaproxy.yap.extension.httppanel.DisplayedMessageChangedListener;
import org.yaproxy.yap.model.ContextDataFactory;
import org.yaproxy.yap.network.HttpSenderListener;
import org.yaproxy.yap.view.ContextPanelFactory;
import org.yaproxy.yap.view.HrefTypeInfo;
import org.yaproxy.yap.view.MainToolbarPanel;
import org.yaproxy.yap.view.SiteMapListener;
...
public class ExtensionLoader {
    ...
    // YAP: Added support for site map listeners
    ...
    // YAP: method called by the scanner to load all scanner hooks.
