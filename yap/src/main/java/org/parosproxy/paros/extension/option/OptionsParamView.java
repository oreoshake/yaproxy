...
// YAP: 2012/03/15 Removed the options of the http panels.
...
// YAP: 2013/12/13 Added support for optional names in tabs.
// YAP: 2014/03/23 Issue 589: Move Reveal extension to YAP extensions project
// YAP: 2014/04/25 Issue 642: Add timestamps to Output tab(s)
// YAP: 2014/10/07 Issue 1357: Hide unused tabs
// YAP: 2014/10/09 Issue 1359: Options for splash screen
// YAP: 2014/12/16 Issue 1466: Config option for 'large display' size
// YAP: 2015/03/04 Added dev build warning option
// YAP: 2016/04/04 Do not require a restart to show/hide the tool bar
// YAP: 2016/04/06 Fix layouts' issues
// YAP: 2016/04/27 Save, always, the Locale as String
// YAP: 2016/05/13 Add options to confirm removal of exclude from proxy, scanner and spider regexes
// YAP: 2017/05/29 Add option to use system's locale for formatting.
// YAP: 2017/09/26 Use helper methods to read the configurations.
// YAP: 2018/01/25 Remove unused constant LOCALES.
// YAP: 2018/02/14 Remove unnecessary boxing / unboxing
// YAP: 2018/02/27 Added support for selecting the look and feel.
// YAP: 2018/06/11 Added options for Work Panels Font.
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2020/02/24 Persist the class of the selected look and feel.
// YAP: 2020/09/29 Add support for dynamic Look and Feel switching (Issue 6201)
// YAP: 2020/10/26 Update pop up menus when changing look and feel.
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2021/09/16 Add support for enabling app integration in containers
// YAP: 2022/02/25 Deprecate options no longer in use.
// YAP: 2022/02/26 Remove code deprecated in 2.5.0
// YAP: 2022/04/28 Add set and get of the open recent menu
// YAP: 2022/09/21 Use format specifiers instead of concatenation when logging.
// YAP: 2023/01/10 Tidy up logger.
// YAP: 2023/01/21 Add option to set icon size independently of font.
...
// YAP: Added support for selecting the locale
...
public class OptionsParamView extends AbstractParam {
     ...
     *     #getFontSize(org.yaproxy.yap.utils.FontUtils.FontType)}.
     */
    @Deprecated
    ...
    /**
     * @deprecated (2.8.0) Replaced by {@link #setFontSize(org.yaproxy.yap.utils.FontUtils.FontType,
     *     int)}.
     */
    @Deprecated
    ...
    /**
     * @deprecated (2.8.0) Replaced by {@link
     *     #getFontName(org.yaproxy.yap.utils.FontUtils.FontType)}.
     */
    @Deprecated
    ...
    /**
     * @deprecated (2.8.0) Replaced by {@link #setFontName(org.yaproxy.yap.utils.FontUtils.FontType,
     *     String)}.
     */
    @Deprecated
