...
// YAP: 2012/03/15 Changed the method initialize to check if "fw" is not null before closing.
// Made the "log" final.
// YAP: 2012/04/25 Added @Override annotation to all appropriate methods.
// YAP: 2012/07/29 Issue 43: Cleaned up access to ExtensionHistory UI
// YAP: 2012/11/01 Changed to load the HttpMessage from the database only once.
// YAP: 2013/03/03 Issue 546: Remove all template Javadoc comments
// YAP: 2014/03/23 Changed to a JMenuItem.
// YAP: 2016/04/05 Issue 2458: Fix xlint warning messages
// YAP: 2016/07/25 Remove String constructor (unused/unnecessary)
// YAP: 2018/03/29 Use FileNameExtensionFilter.
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2019/11/05 Use WritableFileChooser for saves.
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2021/04/08 Name logger (LOG) fullcaps as constant, use LF as EOL for text file content
// YAP: 2022/02/08 Use isEmpty where applicable.
// YAP: 2022/05/13 Deprecated for relocation to exim.
...
public class PopupMenuExportMessage extends JMenuItem {
    ...
    public PopupMenuExportMessage() {
        super(Constant.messages.getString("history.export.messages.popup")); // YAP: i18n
    ...
    private void exportHistory(HistoryReference ref, Writer writer) {
        ...
        try {
            // YAP: Changed to load the HttpMessage from the database only once.
