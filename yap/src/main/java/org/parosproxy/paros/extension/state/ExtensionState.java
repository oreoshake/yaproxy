...
// YAP: 2012/05/03 Changed the method hook(ExtensionHook) to check if there is
// a view.
...
// YAP: 2017/05/02 Removed Menu Item 'Session tracking'
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2022/04/25 Deprecate the class.
...
public class ExtensionState extends ExtensionAdaptor implements SessionChangedListener {
    ...
    public void hook(ExtensionHook extensionHook) {
        ...
        // YAP: Changed to check if there is a view.
        if (getView() != null) {
            extensionHook
                    .getHookMenu()
