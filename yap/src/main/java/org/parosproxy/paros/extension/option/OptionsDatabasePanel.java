...
import org.yaproxy.yap.utils.YapSizeNumberSpinner;
...
public class OptionsDatabasePanel extends AbstractParamPanel {
    ...
    private YapSizeNumberSpinner spinnerRequestBodySize = null;

    /** The spinner to select the size of the response body in the History table */
    private YapSizeNumberSpinner spinnerResponseBodySize = null;
    ...
    private YapSizeNumberSpinner getRequestBodySize() {
        if (spinnerRequestBodySize == null) {
            spinnerRequestBodySize = new YapSizeNumberSpinner(16777216);
        }
    ...
    private YapSizeNumberSpinner getResponseBodySize() {
        if (spinnerResponseBodySize == null) {
            spinnerResponseBodySize = new YapSizeNumberSpinner(16777216);
        }
