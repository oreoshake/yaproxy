...
// YAP: 2012/01/12 Renamed the class from ExtensionPopupMenu to ExtensionPopupMenuItem
//                 and added the method succeedWithSeparator
// YAP: 2012/03/03 Added setters for separators
// YAP: 2012/07/11 Issue 323: Added support for supermenus
...
// YAP: 2014/03/23 Changed to implement the interface ExtensionPopupMenuComponent
// YAP: 2014/03/23 Changed to implement the new method from ExtensionPopupMenuComponent
// YAP: 2014/03/23 Issue 1095: Replace main pop up sub menus with ExtensionPopupMenu when
// appropriate
// YAP: 2014/08/14 Issue 1302: Context menu item action might not get executed
// YAP: 2017/06/01 Add more constructors.
...
public class ExtensionPopupMenuItem extends JMenuItem implements ExtensionPopupMenuComponent {
    ...
    // YAP: Support submenus
    public boolean isSubMenu() {
        return false;
    }

    // YAP: Support dummy menu items - used for dynamic menus
    public boolean isDummyItem() {
        return false;
    }

    // YAP: Added precedeWithSeparator
    @Override
    ...
    // YAP: Added succeedWithSeparator
    @Override
