...
// YAP: 2022/04/28 Call the new message sender method.
...
import org.yaproxy.yap.extension.httppanel.HttpPanel;
...
public class ManualHttpRequestEditorDialog
    ...
    @Override
    public YapMenuItem getMenuItem() {
        if (menuItem == null) {
            menuItem =
                    new YapMenuItem(
                            "menu.tools.manReq",
