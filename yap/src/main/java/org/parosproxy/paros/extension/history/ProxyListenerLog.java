 ...
 */
// YAP: 2012/03/15 Changed the method addHistory to use the class StringBuilder
...
// YAP: 2015/09/07 Issue 1872: EDT accessed in daemon mode
// YAP: 2016/05/30 Issue 2494: YAP Proxy is not showing the HTTP CONNECT Request in history tab
// YAP: 2018/03/14 Publish event when href added
// YAP: 2018/04/11 Log the message synchronously to avoid following listeners to change it before
// being persisted.
...
// YAP: 2020/08/04 Changed to use new SessionStructure method
...
public class ProxyListenerLog implements ProxyListener, ConnectRequestProxyListener {
    ...
    // YAP: Must be the last one of all listeners to be notified, as is the one that saves the
    // HttpMessage
