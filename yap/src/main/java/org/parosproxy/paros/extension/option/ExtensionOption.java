...
// YAP: 2012/03/10 Issue 279: Flag as a core extension
// YAP: 2012/03/17 Issue 282 Added getAuthor()
// YAP: 2012/04/25 Added @Override annotation to all appropriate methods.
// YAP: 2012/07/02 Added the instance variable optionsDatabasePanel and the
...
// YAP: 2015/08/17 Issue 1795: Allow JVM options to be configured via GUI
...
// YAP: 2017/11/06 Moved options panel to new proxies extension (Issue 3983)
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2022/05/20 Remove Connection panel.
// YAP: 2022/05/29 Remove Client Certificate panel.
...
import org.yaproxy.yap.extension.autoupdate.OptionsCheckForUpdatesPanel;
import org.yaproxy.yap.extension.lang.OptionsLangPanel;
    ...
    private JCheckBoxMenuItem getMenuViewImage() {
        if (menuViewImage == null) {
            ...
            menuViewImage.setText(
                    Constant.messages.getString("menu.view.enableImage")); // YAP: i18n
