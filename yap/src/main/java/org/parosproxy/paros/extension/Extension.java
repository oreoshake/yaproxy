...
// YAP: 2012/03/17 Issue 282 Added getAuthor() and getURL();
// YAP: 2012/12/08 Issue 428: Added support for extension specific I18N bundles, to support the
// marketplace
...
// resources open
// YAP: 2014/02/28 Issue 1057: Add a Extension.postInstall() method for post install actions
// YAP: 2015/01/04 Issue 1472: Allow extensions to specify a name for UI components
...
// YAP: 2017/02/17 Expose ExtensionHook to allow core code remove/unhook the extension.
// YAP: 2017/05/22 Use Class<? extends Extension> for dependencies of the extension.
// YAP: 2017/05/25 Add JavaDoc to isEnabled/setEnabled.
// YAP: 2018/06/01 Add JavaDoc to getMessages/setMessages.
// YAP: 2018/10/09 Remove getExtensionHook and add JavaDoc to hook.
// YAP: 2018/04/17 Deprecate getVersion().
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2019/09/12 Add defaults to getAuthor() and getURL().
// YAP: 2020/03/09 Default getURL() to null.
// YAP: 2021/04/13 Update JavaDoc of stop() and destroy().
...
public interface Extension {
    ...
    /**
     * Unloads any component manually added to YAP or other extensions (that is, a component that
     ...
     * the user will be given the option not to exit YAP or, if the extension is bundled in an
     ...
     * any the user will be given the option not to exit YAP or, if the extension is bundled in an
     * add-on that's being updated or uninstalled, not to continue with the changes.
     *
     ...
     * only be called if the user adds the add-on via YAP, e.g. file the File menu or the
