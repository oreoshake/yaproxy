 ...
 */
// YAP: 2012/01/12 Changed the method valueChanged of the ListSelectionListener.
// YAP: 2012/03/15 Changed to allow clear the displayQueue.
// YAP: 2012/04/25 Added @Override annotation to all appropriate methods.
// YAP: 2012/04/28 Added logger and log of exception.
// YAP: 2012/05/02 Changed to use the class literal, instead of getting the
// class at runtime, to get the resource.
// YAP: 2012/07/29 Issue 43: added Scope support
// YAP: 2013/02/26 Issue 538: Allow non sequential lines to be selected in the history log
...
// YAP: 2013/11/16 Issue 898: Replace all toggle buttons that set a tool tip text based on button's
// state with YapToggleButton
// YAP: 2013/11/16 Issue 899: Remove "manual" update of toggle buttons' icon based on button's state
...
// YAP: 2014/02/07 Issue 207: Give the most suitable component focus on tab switch
...
// YAP: 2017/01/30 Use HistoryTable.
// YAP: 2017/03/03 Tweak filter label.
// YAP: 2017/05/12 Support table export.
// YAP: 2017/09/02 Use KeyEvent instead of Event (deprecated in Java 9).
// YAP: 2017/10/20 Add action/shortcut to delete history entries (Issue 3626).
// YAP: 2018/01/29 Make getHistoryReferenceTable protected (Issue 4000).
...
// YAP: 2020/01/02 Allow to set if messages are displayed.
// YAP: 2020/07/09 Removed unused variable (and related import) and remove boilerplate javadoc for
// getScrollLog()
...
// YAP: 2022/01/15 Added Clear Button for History Tab (Issue 7477).
...
import org.yaproxy.yap.utils.TableExportButton;
import org.yaproxy.yap.view.DeselectableButtonGroup;
import org.yaproxy.yap.view.YapToggleButton;
import org.yaproxy.yap.view.table.DefaultHistoryReferencesTableEntry;
import org.yaproxy.yap.view.table.HistoryReferencesTable;
import org.yaproxy.yap.view.table.HistoryReferencesTableModel;
...
public class LogPanel extends AbstractPanel {
    ...
    // YAP: Added history (filter) toolbar
    ...
    private YapToggleButton linkWithSitesTreeButton;
    ...
    private JButton getFilterButton() {
        if (filterButton == null) {
            ...
            // YAP: Changed to use the class literal.
    ...
    private JToggleButton getLinkWithSitesTreeButton() {
        if (linkWithSitesTreeButton == null) {
            linkWithSitesTreeButton = new YapToggleButton();
    ...
    protected HistoryReferencesTable getHistoryReferenceTable() {
        if (historyReferencesTable == null) {
            ...
            String deleteHrefKey = "yap.delete.href";
