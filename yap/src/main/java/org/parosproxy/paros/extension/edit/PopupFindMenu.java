...
// YAP: 2012/10/23 Changed to prevent a NullPointerException when there's no
// parent JFrame (changed to use SwingUtilities.getAncestorOfClass(...)).
// YAP: 2016/04/05 Issue 2458: Fix xlint warning messages
// YAP: 2017/07/22 Leverage KeyStroke constant for consistency with other FindDialog usage
// YAP: 2017/08/10 Issue 3798: java.awt.Toolkit initialised in daemon mode
// YAP: 2017/10/18 Drop support of JFrame as parent (that might not be the case, e.g. parentless
// JDialog).
...
public class PopupFindMenu extends ExtensionPopupMenuItem {
    ...
    private void initialize() {
        this.setText(Constant.messages.getString("edit.find.popup")); // YAP: i18n
