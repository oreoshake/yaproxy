 ...
 */
// YAP: 2012/04/25 Changed the type of the parameter "panel" of the method
// addSessionPanel.
// YAP: 2016/04/08 Allow to add ContextPanelFactory
// YAP: 2017/02/19 Allow to add components to the main tool bar.
...
public class ExtensionHookView {
     ...
     * @since 2.6.0
     * @see org.yaproxy.yap.view.MainToolbarPanel#addToolBarComponent(Component)
     * @see org.yaproxy.yap.view.MainToolbarPanel#removeToolBarComponent(Component)
     */
     ...
     * org.yaproxy.yap.extension.httppanel.HttpPanelRequest} ChangeListeners.
     *
     * @see
     *     org.yaproxy.yap.extension.httppanel.HttpPanelRequest#addDisplayedMessageChangedListener(DisplayedMessageChangedListener)
     ...
     * Adds the given {@link DisplayedMessageChangedListener} to the view hook, to be later added to
     * the the {@link org.parosproxy.paros.view.View}s {@link
     * org.yaproxy.yap.extension.httppanel.HttpPanelResponse} ChangeListeners.
     *
     * @see
     *     org.yaproxy.yap.extension.httppanel.HttpPanelResponse#addDisplayedMessageChangedListener(DisplayedMessageChangedListener)
