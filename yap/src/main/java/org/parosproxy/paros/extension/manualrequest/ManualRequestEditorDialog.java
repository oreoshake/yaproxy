...
// YAP: 2011/08/04 Changed to support new Features
// YAP: 2011/08/04 Changed to support new interface
// YAP: 2012/03/15 Changed so the display options can be modified dynamically.
// YAP: 2012/07/02 Wraps no HttpMessage object, but more generalized Message.
// new map of supported message types; removed history list; removed unused
// methods.
// YAP: 2012/07/16 Issue 326: Add response time and total length to manual request dialog
// YAP: 2012/07/31 Removed the instance variables followRedirect,
...
// YAP: 2012/11/21 Heavily refactored extension to support non-HTTP messages.
...
// YAP: 2020/11/03 Warn when unable to save the message (Issue 4235).
// YAP: 2020/11/20 Support Send button in response panel in tab mode
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2021/02/12 Add shortcut key to Send button (Issue 6448).
// YAP: 2022/06/08 Fix resizing issues.
// YAP: 2022/06/23 Do not implement Tab.
// YAP: 2022/09/14 Deprecate the class.
...
public abstract class ManualRequestEditorDialog extends AbstractFrame {
     ...
     * @return
     */
    public abstract YapMenuItem getMenuItem();
