 ...
 */
// YAP: 2011/04/16 i18n
// YAP: 2012/04/25 Added @Override annotation to the appropriate methods.
...
// YAP: 2016/06/28: File chooser for PKCS#12 files now also accepts .pfx files
// YAP: 2017/01/09 Remove method no longer needed.
// YAP: 2017/01/23 Select first alias of selected keystore
// YAP: 2017/08/16 Tidy up usage of CertificateView.
// YAP: 2017/08/16 Show error message if failed to activate the certificate.
// YAP: 2017/08/17 Reduce code duplication when showing cert/keystore errors
// YAP: 2017/12/12 Use first alias by default (Issue 3879).
// YAP: 2017/12/13 Do not allow to edit the name/key of active cert.
// YAP: 2018/02/14 Remove unnecessary boxing / unboxing
// YAP: 2018/03/29 Use FileNameExtensionFilter.
// YAP: 2018/07/12 Fallback to bundled drivers.xml file.
// YAP: 2018/09/19 GUI support for setting client certificate from CLI
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2022/05/21 Remove unsafe SSL/TLS renegotiation option.
// YAP: 2022/05/29 Deprecate the class.
...
public class OptionsCertificatePanel extends AbstractParamPanel {
    ...
    private YapTextField certificateTextField;
    ...
    private YapTextField fileTextField;
    ...
    private static ch.csnc.extension.util.DriverConfiguration createDriverConfiguration() {
        ...
        Path path = Paths.get(Constant.getYapInstall(), "xml", fileName);
        ...
        return new ch.csnc.extension.util.DriverConfiguration(
                OptionsCertificatePanel.class.getResource(
                        "/org/yaproxy/yap/resources/" + fileName));
    }
    ...
    private JPanel getPanelCertificate() {
        if (certificatePanel == null) {
            ...
            fileTextField = new YapTextField();
            ...
            certificateTextField = new YapTextField();
