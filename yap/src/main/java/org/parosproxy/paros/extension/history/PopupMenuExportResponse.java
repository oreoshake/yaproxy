...
// YAP: 2018/08/15 Added null check
...
// YAP: 2021/04/08 Set/name logger (LOG) fullcaps as constant, use LF as EOL for text file content
...
public class PopupMenuExportResponse extends JMenuItem {
    ...
    public PopupMenuExportResponse() {
        super(Constant.messages.getString("history.export.response.popup")); // YAP: i18n
                            ...
                            extension
                                    ...
                                    .showWarningDialog(
                                            Constant.messages.getString(
                                                    "history.export.response.select.warning")); // YAP: i18n
                            return;
                        }
