...
// YAP: 2012/05/03 Changed the method find to check if txtComp is null.
// YAP: 2014/01/30 Issue 996: Ensure all dialogs close when the escape key is pressed (copy tidy up)
// YAP: 2017/07/12 Issue 765: Add constructor with window parent, to facilitate ctrl-F in various
// HttpPanels
// YAP: 2017/07/17: Prevent opening multiple dialogs per parent.
// YAP: 2017/10/18 Do not allow to obtain the FindDialog with a null parent.
// YAP: 2018/08/17 Show a message if the string was not found (Issue 4935).
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2021/04/08 Remove boilerplate javadoc.
// YAP: 2022/04/07 Put any selected text into the Find dialog text area.
...
public class FindDialog extends AbstractDialog {
    ...
    private YapTextField txtFind = null;
    ...
    private void find() {
        ...
        // YAP: Check if a JTextComponent was really found.
        if (txtComp == null) {
            return;
        }
    ...
    private YapTextField getTxtFind() {
        if (txtFind == null) {
            txtFind = new YapTextField(15);
        }
        return txtFind;
    }
