 ...
 */
// YAP: 2014/02/21 Issue 1043: Custom active scan dialog - moved code from AbstractParamDialog
// YAP: 2015/02/16 Issue 1528: Support user defined font size
// YAP: 2016/06/14 Issue 2578: Must click on text in Options column to select row
// YAP: 2016/08/23 Respect sort parameter when adding intermediate panels
// YAP: 2016/10/27 Explicitly show other panel when the selected panel is removed.
// YAP: 2017/06/23 Ensure panel with validation errors is visible.
// YAP: 2017/09/03 Cope with Java 9 change to TreeNode.children().
// YAP: 2017/12/09 Issue 3358: Added SearchPanel.
// YAP: 2018/01/08 Allow to expand the node of a param panel.
// YAP: 2018/03/26 Ensure node of selected panel is visible.
// YAP: 2018/04/12 Allow to check if a param panel is selected.
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2020/03/24 Remove hardcoded white background on Headline field (part of Issue 5542).
// YAP: 2020/08/25 Catch NullPointerException when validating/saving the panel.
// YAP: 2020/10/26 Use empty border in the help button, to prevent the look and feel change from
// resetting it. Also, use the icon from the ExtensionHelp.
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2021/11/19 Remove empty parent nodes.
// YAP: 2022/02/12 Show child panel if parent has none.
// YAP: 2022/05/11 Use a unique ID to identify the panels instead of their name (Issue 5637).
// YAP: 2022/06/08 Fix resizing issues.
...
import org.yaproxy.yap.view.panelsearch.ComponentHighlighterProvider;
import org.yaproxy.yap.view.panelsearch.ComponentSearchProvider;
import org.yaproxy.yap.view.panelsearch.SearchAndHighlight;
import org.yaproxy.yap.view.panelsearch.items.AbstractComponentSearch;
import org.yaproxy.yap.view.panelsearch.items.TreeNodeElement;
import org.yaproxy.yap.view.panelsearch.items.TreeUtils;
...
public class AbstractParamContainerPanel extends JSplitPane {
    ...
    private YapTextField txtHeadline = null;
    ...
    private void initialize() {
        ...
        // YAP: added more space for readability (was 175)
     ...
     */
    private YapTextField getTxtHeadline() {
        if (txtHeadline == null) {
            txtHeadline = new YapTextField();
    ...
    // YAP: Made public so that other classes can specify which panel is displayed
    ...
    private void showParamPanel(ParamTreeNode node) {
        ...
        // YAP: Notify previously shown panel that it was hidden
        ...
        // YAP: Notify the new panel that it is now shown
        panel.onShow();
    }
    ...
    // YAP: Added option to specify panel - note this only supports one level at the moment
    // YAP: show the last selected panel
    ...
    // YAP: Added accessor to the panels
    /**
    ...
    private ParamTreeNode getTreeNodeFromPanelName(ParamTreeNode parent, String panel) {
        ...
        // YAP: Added @SuppressWarnings annotation.
    ...
    private YapTextField getSearchTextField() {
        if (searchTextField == null) {
            searchTextField = new YapTextField();
