...
// YAP: 2011/07/25 Added automatically save/restore of divider locations
...
// YAP: 2013/05/02 Removed redundant final modifiers from private methods
// YAP: 2013/12/13 Added support for 'Full Layout'.
// YAP: 2014/01/28 Issue 207: Support keyboard shortcuts
// YAP: 2014/10/07 Issue 1357: Hide unused tabs
// YAP: 2015/02/11 Ensure that a tab is always selected when the layout is switched
// YAP: 2015/12/14 Disable request/response tab buttons location when in full layout
// YAP: 2016/04/06 Fix layouts' issues
// YAP: 2017/08/30 Add tool tip to response tab.
// YAP: 2018/02/14 Add new layout ResponsePanelPosition.TAB_SIDE_BY_SIDE (Issue 4331).
// YAP: 2018/04/03 Update for behavioural changes in TabbedPanel2.
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2020/11/02 Add OneTouchExapandable control to Sites Tree/Request&Response panels
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2022/02/26 Remove deprecated methods in 2.5.0
...
public class WorkbenchPanel extends JPanel {
    ...
    public TabbedPanel2 getTabbedStatus() {
        if (tabbedStatus == null) {
            ...
            // YAP: Move tabs to the top of the panel
