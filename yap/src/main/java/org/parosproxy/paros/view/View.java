 ...
 */
// YAP: 2011/08/04 Changed to support new HttpPanel interface
// YAP: 2011/05/15 Support for exclusions
// YAP: 2011/05/31 Added option to dynamically change the display
// YAP: 2012/02/18 Changed default to be 'bottom full'
// YAP: 2012/03/15 Changed to set the configuration key to the HttpPanels, load
// the configuration and disable the response panel.
// YAP: 2012/04/23 Added @Override annotation to all appropriate methods.
// YAP: 2012/04/26 Removed the method setStatus(String), no longer used.
// YAP: 2012/07/02 HttpPanelRequest and -Response constructor changed.
// YAP: 2012/07/23 Removed title parameter in method getSessionDialog().
// Added @Override to getSessionDialog() as exposed in ViewDelegate interface.
// YAP: 2012/07/29 Issue 43: Added support for Scope
// YAP: 2012/08/01 Issue 332: added support for Modes
// YAP: 2012/08/07 Removed the unused method changeDisplayOption(int)
// YAP: 2012/10/02 Issue 385: Added support for Contexts
// YAP: 2012/10/03 Issue 388: Added support for technologies
// YAP: 2012/12/18 Issue 441: Prevent view being initialised in daemon mode
// YAP: 2013/01/16 Issue 453: Dynamic loading and unloading of add-ons - added helper methods
...
// position changed
// YAP: 2013/04/15 Issue 627: Allow add-ons to remove main tool bar buttons/separators
// YAP: 2013/07/23 Issue 738: Options to hide tabs
// YAP: 2013/08/21 Support for shared context for Context Properties Panels.
// YAP: 2013/12/13 Disabled the updating of 'Sites' tab, because it has been added elsewhere to
// accommodate the 'Full Layout' functionality.
// YAP: 2014/01/06 Issue 965: Support 'single page' apps and 'non standard' parameter separators
// YAP: 2014/01/19 Added option to execute code after init of the panels when showing the session
// dialog
// YAP: 2014/01/28 Issue 207: Support keyboard shortcuts
// YAP: 2014/03/23 Issue 1085: Do not add/remove pop up menu items through the method
// View#getPopupMenu()
// YAP: 2014/04/17 Issue 1155: Historical Request Tab Doesn't allow formatting changes
// YAP: 2014/07/15 Issue 1265: Context import and export
// YAP: 2014/09/22 Issue 1345: Support Attack mode
// YAP: 2014/10/07 Issue 1357: Hide unused tabs
// YAP: 2014/10/24 Issue 1378: Revamp active scan panel
// YAP: 2014/10/31 Issue 1176: Changed parents to Window as part of spider advanced dialog changes
// YAP: 2014/11/23 Added Splash Screen management
// YAP: 2014/12/22 Issue 1476: Display contexts in the Sites tree
// YAP: 2015/01/19 Expose splash screen as Component
// YAP: 2015/02/02 Move output panel help key registration to prevent NPE
// YAP: 2015/03/04 Added no prompt warning methods
// YAP: 2015/04/13 Add default editor and renderer for TextMessageLocationHighlight
// YAP: 2015/08/11 Fix the removal of context panels
// YAP: 2015/09/07 Start GUI on EDT
// YAP: 2015/11/26 Issue 2084: Warn users if they are probably using out of date versions
// YAP: 2016/03/16 Add StatusUI handling
// YAP: 2016/03/22 Allow to remove ContextPanelFactory
// YAP: 2016/03/23 Issue 2331: Custom Context Panels not show in existing contexts after
// installation of add-on
// YAP: 2016/04/04 Do not require a restart to show/hide the tool bar
// YAP: 2016/04/06 Fix layouts' issues
// YAP: 2016/04/14 Allow to display a message
// YAP: 2016/10/26 Create UI shared context in the session dialogue when adding a context
// YAP: 2017/02/20 Issue 3221: Some icons not scaled correctly
// YAP: 2017/08/31 Use helper method I18N.getString(String, Object...).
// YAP: 2017/09/02 Use KeyEvent instead of Event (deprecated in Java 9).
// YAP: 2017/10/20 Implement method to expose default delete keyboard shortcut (Issue 3626).
// YAP: 2017/10/31 Use ExtensionLoader.getExtension(Class).
// YAP: 2018/01/08 Expand first context added.
// YAP: 2018/03/30 Check if resource message exists (for changes in I18N).
// YAP: 2018/07/13 Added canGetFocus option
// YAP: 2018/07/17 Use getMenuShortcutKeyStroke.
// YAP: 2019/01/04 Keep Show Tab menu item in the position it was added.
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2019/07/10 Update to use Context.getId following deprecation of Context.getIndex
// YAP: 2019/12/13 Update new footer proxy label in postInit (Issue 2016)
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2022/02/09 Remove method call no longer needed.
// YAP: 2022/02/26 Remove code deprecated in 2.5.0
// YAP: 2022/05/29 Implement getOptionsDialog().
// YAP: 2022/09/21 Use format specifiers instead of concatenation when logging.
// YAP: 2022/09/27 Added dialog methods with YapHtmlLabel parameter.
...
import org.yaproxy.yap.control.AddOn;
import org.yaproxy.yap.control.AddOn.Status;
import org.yaproxy.yap.extension.ExtensionPopupMenu;
import org.yaproxy.yap.extension.help.ExtensionHelp;
import org.yaproxy.yap.extension.httppanel.HttpPanelRequest;
import org.yaproxy.yap.extension.httppanel.HttpPanelResponse;
import org.yaproxy.yap.extension.httppanel.Message;
import org.yaproxy.yap.extension.keyboard.ExtensionKeyboard;
...
import org.yaproxy.yap.view.ContextExcludePanel;
import org.yaproxy.yap.view.ContextGeneralPanel;
import org.yaproxy.yap.view.ContextIncludePanel;
import org.yaproxy.yap.view.ContextListPanel;
import org.yaproxy.yap.view.ContextPanelFactory;
import org.yaproxy.yap.view.ContextStructurePanel;
import org.yaproxy.yap.view.ContextTechnologyPanel;
import org.yaproxy.yap.view.SessionExcludeFromProxyPanel;
import org.yaproxy.yap.view.SessionExcludeFromScanPanel;
import org.yaproxy.yap.view.SessionExcludeFromSpiderPanel;
import org.yaproxy.yap.view.SplashScreen;
import org.yaproxy.yap.view.StatusUI;
import org.yaproxy.yap.view.YapMenuItem;
import org.yaproxy.yap.view.messagelocation.MessageLocationHighlightRenderersEditors;
import org.yaproxy.yap.view.messagelocation.TextMessageLocationHighlight;
import org.yaproxy.yap.view.messagelocation.TextMessageLocationHighlightEditor;
import org.yaproxy.yap.view.messagelocation.TextMessageLocationHighlightRenderer;
...
public class View implements ViewDelegate {
    ...
    //  YAP: Removed method changeDisplayOption(int)
    public void init() {
     ...
     * @since 2.12.0
     */
    public int showConfirmDialog(YapHtmlLabel label) {
     ...
     * @since 2.12.0
     */
    public int showConfirmDialog(JPanel parent, YapHtmlLabel label) {
        return JOptionPane.showConfirmDialog(
     ...
     * @since 2.12.0
     */
    public int showConfirmDialog(Window parent, YapHtmlLabel label) {
        return JOptionPane.showConfirmDialog(
                parent, label, Constant.PROGRAM_NAME, JOptionPane.OK_CANCEL_OPTION);
    }
     ...
     * @since 2.12.0
     */
    public int showYesNoCancelDialog(YapHtmlLabel label) {
     ...
     * @since 2.12.0
     */
    public int showYesNoCancelDialog(JPanel parent, YapHtmlLabel label) {
        return JOptionPane.showConfirmDialog(
     ...
     * @since 2.12.0
     */
    public int showYesNoCancelDialog(Window parent, YapHtmlLabel label) {
        return JOptionPane.showConfirmDialog(
                parent, label, Constant.PROGRAM_NAME, JOptionPane.YES_NO_CANCEL_OPTION);
    }
     ...
     * @since 2.12.0
     */
    public void showWarningDialog(YapHtmlLabel label) {
     ...
     * @since 2.12.0
     */
    public void showWarningDialog(JPanel parent, YapHtmlLabel label) {
        JOptionPane.showMessageDialog(
     ...
     * @since 2.12.0
     */
    public void showWarningDialog(Window parent, YapHtmlLabel label) {
        JOptionPane.showMessageDialog(
                parent, label, Constant.PROGRAM_NAME, JOptionPane.WARNING_MESSAGE);
    }
     ...
     * @since 2.12.0
     */
    public void showMessageDialog(YapHtmlLabel label) {
     ...
     * @since 2.12.0
     */
    public void showMessageDialog(JPanel parent, YapHtmlLabel label) {
        JOptionPane.showMessageDialog(
     ...
     * @since 2.12.0
     */
    public void showMessageDialog(Window parent, YapHtmlLabel label) {
        JOptionPane.showMessageDialog(
                parent, label, Constant.PROGRAM_NAME, JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    // YAP: FindBugs fix - make method synchronised
    ...
    public SessionDialog getSessionDialog() {
        if (sessionDialog == null) {
            String[] ROOT = {};
            // YAP: i18n, plus in-lined title parameter
    ...
    public OptionsDialog getOptionsDialog(String title) {
        // YAP: FindBugs fix - dont need ROOT
        // String[] ROOT = {};
    ...
    // YAP: Removed the method setStatus(String), no longer used.
    /**
    ...
    // YAP: Added main toolbar methods
