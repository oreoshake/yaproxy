...
// YAP: 2012/03/15 Changed so the change display option stays visually selected.
// YAP: 2012/04/26 Removed the method setStatus(String) and instance variable
// "txtStatus".
...
// application
// YAP: 2018/02/14 Add button for ResponsePanelPosition.TAB_SIDE_BY_SIDE (Issue 4331).
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2019/12/13 Display the primary proxy details (host:port) in the footer (Issue 2016).
// YAP: 2020/09/29 Add support for dynamic Look and Feel switching (Issue 6201)
...
import org.yaproxy.yap.view.widgets.PopupButton;
...
public class MainFrame extends AbstractFrame {
    ...
    // YAP: Removed instance variable (JLabel txtStatus). The status label that
    ...
    /**
     * The {@code YapToggleButton} that sets whether or not the tabs should show the panels' names.
     *
     * <p>Lazily initialised.
     *
     * @see #getShowTabIconNamesButton()
     */
    private YapToggleButton showTabIconNamesButton;
    ...
    /**
     * The {@code YapToggleButton} that sets the response panel position {@link
     ...
     */
    private YapToggleButton tabsResponsePanelPositionButton;
     ...
     */
    private YapToggleButton tabSideBySideResponsePanelPositionButton;
     ...
     */
    private YapToggleButton aboveResponsePanelPositionButton;
     ...
     */
    private YapToggleButton panelsResponsePanelPositionButton;
    ...
    // YAP: Removed the method getTxtStatus()

    // YAP: Removed the method setStatus(String). The status label
    ...
    private JToggleButton getShowTabIconNamesButton() {
        if (showTabIconNamesButton == null) {
            showTabIconNamesButton = new YapToggleButton();
    ...
    private YapToggleButton getTabsResponsePanelPositionButton() {
    ...
    private YapToggleButton getTabSideBySideResponsePanelPositionButton() {
    ...
    private YapToggleButton getPanelsResponsePanelPositionButton() {
    ...
    private YapToggleButton getAboveResponsePanelPositionButton() {
    ...
    // YAP: Added footer toolbar panel
