...
// application
// YAP: 2017/06/07 Don't close the Session when changing session's name/description.
...
public class SessionGeneralPanel extends AbstractParamPanel {
    ...
    private YapTextField txtSessionName = null;
    private YapTextArea txtDescription = null;
    private YapTextArea location = null;
     ...
     */
    private YapTextField getTxtSessionName() {
        if (txtSessionName == null) {
            txtSessionName = new YapTextField();
        }
     ...
     */
    private YapTextArea getTxtDescription() {
        if (txtDescription == null) {
            txtDescription = new YapTextArea();
    ...
    private YapTextArea getSessionLocation() {
        if (location == null) {
            location = new YapTextArea();
