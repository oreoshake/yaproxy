...
// YAP: 2012/02/19 Removed the Delete button
// YAP: 2012/03/03 Moved popups to stdmenus extension
// YAP: 2012/04/23 Added @Override annotation to the appropriate method.
// YAP: 2012/06/06 Issue 323: Added isDummyItem to support dynamic menus
// YAP: 2012/08/01 Issue 332: added support for Modes
// YAP: 2012/10/07 Added support for prepareShow() that is run on PopupMenu before showing it
// YAP: 2012/10/08 Added check for PopupMenu safeness
// YAP: 2013/04/14 Issue 592: Do not show the main pop up menu if it doesn't have visible pop up
// menu items
// YAP: 2013/04/14 Issue 598: Replace/update "old" pop up menu items
// YAP: 2013/11/16 Issue 878: ExtensionPopupMenuItem#getMenuIndex() as no effect in MainPopupMenu
// YAP: 2013/11/16 Issue 901: Pop up menu "succeed" separator is not added when using sub-menu in
// MainPopupMenu
// YAP: 2013/11/16 Issue 900: IllegalArgumentException when invoking the main pop up menu with
// menus or super menus with high menu index
// YAP: 2014/03/23 Changed to use PopupMenuUtils.isAtLeastOneChildComponentVisible(Component).
...
// YAP: 2014/03/23 Issue 1079: Remove misplaced main pop up menu separators
// YAP: 2014/03/23 Issue 1088: Deprecate the method ExtensionPopupMenu#prepareShow
// YAP: 2014/08/14 Issue 1302: Context menu item action might not get executed
// YAP: 2015/01/22 Use ExtensionPopupMenu for super menus
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2022/02/03 Removed deprecated prepareShow method
...
import org.yaproxy.yap.extension.history.PopupMenuPurgeSites;
import org.yaproxy.yap.view.messagecontainer.MessageContainer;
import org.yaproxy.yap.view.popup.ExtensionPopupMenuComponent;
import org.yaproxy.yap.view.popup.PopupMenuUtils;
import org.yaproxy.yap.view.popup.PopupMenuUtils.PopupMenuInvokerWrapper;
...
public class MainPopupMenu extends JPopupMenu {
    ...
    // YAP: Added support for submenus
        ...
        for (int i = 0; i < getComponentCount(); i++) {
            ...
            try {
                if (component != null && component instanceof ExtensionPopupMenuItem) {
                    ...
                    // YAP: prevents a NullPointerException when the treeSite doesn't have a node
    ...
    // YAP: added addMenu and removeMenu to support dynamic changing of menus
