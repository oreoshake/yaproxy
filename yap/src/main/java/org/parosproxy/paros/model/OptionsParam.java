...
// YAP: 2011/11/02 Added brute force options
// YAP: 2011/11/15 Removed the getConfig method and the config field, now it's
// used the method of the base class.
// YAP: 2012/04/23 Added @Override annotation to the appropriate method.
// YAP: 2012/04/25 Added type argument to generic type.
// YAP: 2012/05/03 Changed the type of one variable in the method getParamSet.
// YAP: 2012/06/30 Added the instance variable databaseParam and the  method
// getDatabaseParam() and changed the method parse() to also load the database
// configurations.
// YAP: 2012/12/31 Removed brute force options
...
// YAP: 2014-02-04 Added GlobalExcludeURL functionality:  Issue: TODO - insert list here.
// YAP: 2014/03/23 Issue 1097: Move "Run applications" (invoke) extension to yap-extensions project
// YAP: 2015/04/09 Generify getParamSet(Class) to avoid unnecessary casts
// YAP: 2016/11/17 Issue 2701 Support Factory Reset
// YAP: 2016/12/06 Add ExtensionParam
// YAP: 2018/08/15 Move AntiCsrfParam to ExtensionAntiCSRF
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2021/05/25 Change the default value of userDirectory from null to the user's home directory.
// YAP: 2022/02/09 Deprecate methods related to core proxy options.
// YAP: 2022/05/20 Deprecate methods related to core connection options.
// YAP: 2022/05/29 Deprecate methods related to core client certificates.
// YAP: 2023/01/10 Tidy up logger.
// YAP: 2023/06/02 Deprecate GlobalExcludeURLParam usage.
...
import org.yaproxy.yap.extension.api.OptionsParamApi;
...
public class OptionsParam extends AbstractParam {
    ...
    // YAP: User directory now stored in the config file
    ...
    // YAP: Added many instance variables for new functionality.
    ...
    private org.yaproxy.yap.extension.globalexcludeurl.GlobalExcludeURLParam globalExcludeURLParam =
            new org.yaproxy.yap.extension.globalexcludeurl.GlobalExcludeURLParam() {
    ...
    // YAP: Added the instance variable.
    ...
    // YAP: Removed the method getConfig().
     ...
     * @deprecated (2.8.0) Use {@link org.yaproxy.yap.extension.anticsrf.ExtensionAntiCSRF
    ...
    public org.yaproxy.yap.extension.globalexcludeurl.GlobalExcludeURLParam
