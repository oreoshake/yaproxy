 ...
 */
// YAP: 2011/07/23 Added TYPE_FUZZER
// YAP: 2011/12/04 Support deleting alerts
// YAP: 2012/03/15 Changed the method getDisplay to use the class StringBuilder
//      instead of StringBuffer.
// YAP: 2012/04/23 Added @Override annotation to the appropriate method.
// YAP: 2012/05/28 Added some JavaDoc
// YAP: 2012/06/13 Optimized alerts related code
// YAP: 2012/08/07 Deleted some not used Spider Related constants
// YAP: 2012/10/08 Issue 391: Performance improvements
// YAP: 2012/02/26 Cache the response body length as part of Issue 539
// YAP: 2013/08/07 Added TYPE_AUTHENTICATION
// YAP: 2013/11/16 Issue 869: Differentiate proxied requests from (YAP) user requests
// YAP: 2013/11/16 Issue 892: Cache of response body length in HistoryReference might not be correct
// YAP: 2014/04/10 Changed to use HttpMessageCachedData and expose the cached data
...
// YAP: 2014/06/10 Added TYPE_ACCESS_CONTROL
// YAP: 2014/06/16 Issue 990: Allow to delete alerts through the API
// YAP: 2014/08/14 Issue 1311: Differentiate temporary internal messages from temporary scanner
// messages
// YAP: 2014/12/11 Update the flag webSocketUpgrade sooner to avoid re-reading the message from
// database
// YAP: 2015/02/09 Issue 1525: Introduce a database interface layer to allow for alternative
// implementations
// YAP: 2016/04/12 Update the SiteNode when deleting alerts
// YAP: 2016/05/27 Moved the temporary types to this class
// YAP: 2016/05/30 Add new type for CONNECT requests received by the proxy
// YAP: 2016/06/15 Add TYPE_SEQUENCE_TEMPORARY
// YAP: 2016/06/20 Add TYPE_ZEST_SCRIPT and deprecate TYPE_RESERVED_11
// YAP: 2016/08/30 Use a Set instead of a List for the alerts
// YAP: 2017/02/07 Add TYPE_SPIDER_AJAX_TEMPORARY.
// YAP: 2017/03/19 Add TYPE_SPIDER_TEMPORARY.
// YAP: 2017/05/03 Notify tag changes.
// YAP: 2017/05/17 Allow to obtain the tags of a message.
// YAP: 2017/05/31 Add a multi-catch for a specific handler.
// YAP: 2017/06/08 Allow to keep the HttpMessage in memory for immediate reuse.
// YAP: 2017/06/13 Notify when a note is set.
// YAP: 2017/07/04 Notify when a HistoryReference is deleted.
// YAP: 2017/08/18 Add TYPE_FUZZER_TEMPORARY.
// YAP: 2018/02/14 Remove unnecessary boxing / unboxing
// YAP: 2019/01/09 Add TYPE_CALLBACK.
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2021/07/07 Add TYPE_OAST.
// YAP: 2022/02/28 Remove code deprecated in 2.6.0
// YAP: 2022/06/27 Add TYPE_PARAM_DIGGER.
...
public class HistoryReference {
    ...
    /** A HTTP message that was proxied through YAP. */
    public static final int TYPE_PROXIED = 1;

    /**
     * A HTTP message sent by the user from within YAP, for example, using "Manual Request Editor"
     * or "Resend" dialogues.
     */
    public static final int TYPE_YAP_USER = 15;

    public static final int TYPE_SPIDER = 2;
    public static final int TYPE_SCANNER = 3;
    public static final int TYPE_HIDDEN = 6;
    // YAP: Added TYPE_BRUTE_FORCE
     ...
     * org.yaproxy.yap.users.User User}.
     *
     * @since 2.4.0
     * @see #DEFAULT_TEMPORARY_HISTORY_TYPES
     */
    ...
    // YAP: Added TYPE_ACCESS_CONTROL for use in access control testing methods
    ...
    /**
     * An HTTP message received by an OAST server that is relayed to YAP.
     *
     * @since 2.11.0
     */
    ...
    // YAP: Support for multiple tags
    private static TableTag staticTableTag = null;
    // YAP: Support for loading alerts from db
    ...
    public HistoryReference(Session session, int historyType, HttpMessage msg)
        ...
        // YAP: Init HttpMessage HistoryReference field
        msg.setHistoryRef(this);
        this.tags = getTags(historyId);

        // YAP: Support for loading the alerts from the db
    ...
    private void build(long sessionId, int historyId, int historyType, HttpMessage msg) {
        ...
        if (historyType == TYPE_PROXIED || historyType == TYPE_YAP_USER) {
    ...
    // YAP: Added setNote method to HistoryReference
