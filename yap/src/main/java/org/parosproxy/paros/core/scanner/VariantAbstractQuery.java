 ...
 */
// YAP: 2012/03/15 Changed the methods (the private) setParameter and paramAppend to
...
// YAP: 2013/07/02 Changed Vector to ArrayList because obsolete and faster
// YAP: 2013/08/21 Added a new encoding/decoding model for a correct parameter value interpretation
// YAP: 2014/01/06 Issue 965: Support 'single page' apps and 'non standard' parameter separators
// YAP: 2014/02/08 Used the same constants used in ScanParam Target settings
// YAP: 2016/05/04 Changes to address issues related to ParameterParser
// YAP: 2016/05/26 Use non-null String for names and values of parameters, scanners might not handle
// null names/values well
// YAP: 2016/09/13 Issue 2863: Attack query string even if not originally specified
// YAP: 2017/11/06 Use indexed names for array parameters (Issue 2496).
...
public abstract class VariantAbstractQuery implements Variant {
     ...
     */
    protected void setParameters(int type, List<org.yaproxy.yap.model.NameValuePair> parameters) {
        if (parameters == null) {
        ...
        int i = 0;
        for (org.yaproxy.yap.model.NameValuePair parameter : parameters) {
