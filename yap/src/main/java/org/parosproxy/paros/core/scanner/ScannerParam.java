...
// YAP: 2012/06/07 Added targetParam options
...
// YAP: 2013/04/26 Issue 652: Added option to not delete records on shutdown
// YAP: 2013/09/23 Issue 795: Allow param types scanned to be configured via UI
// YAP: 2013/09/24 Issue 797: Limit number of ascan results listed to speed up scans
// YAP: 2013/09/26 Reviewed Variant Panel configuration
// YAP: 2014/01/10 Issue 974: Scan URL path elements
// YAP: 2014/02/08 Added Custom Script management settings
// YAP: 2014/02/13 Added HTTP parameter exclusion configuration on Active Scanning
// YAP: 2014/03/23 Issue 1076: Change active scanner to not delete the temporary messages generated
// YAP: 2014/05/13 Issue 1193: Scan URL path elements - turn off by default
...
// YAP: 2015/03/04 Issue 1345: Added 'attack on start' option
// YAP: 2015/03/25 Issue 1573: Add option to inject plugin ID in header for all ascan requests
// YAP: 2015/10/01 Issue 1944:  Chart responses per second in ascan progress
// YAP: 2016/01/20 Issue 1959: Allow to active scan headers of all requests
// YAP: 2016/10/24 Issue 2951:  Support active scan rule and scan max duration
// YAP: 2017/01/13 Exclude getExcludedParamList from the YAP API
// YAP: 2017/09/26 Use helper methods to read the configurations.
// YAP: 2018/02/14 Remove unnecessary boxing / unboxing
// YAP: 2018/09/12 Make the addition of a query parameter optional.
// YAP: 2019/05/10 Enable custom (script) input vectors by default.
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2021/04/13 Issue 6469: Add option to scan null JSON values.
// YAP: 2021/09/14 Enable Anti CSRF handling by default.
// YAP: 2022/09/21 Use format specifiers instead of concatenation when logging.
// YAP: 2022/11/04 Prevent invalid number of hosts/threads.
// YAP: 2022/12/22 Issue 7663: Default thread to number of processors.
// YAP: 2023/01/10 Tidy up logger.
// YAP: 2023/05/17 Add option for the maximum number of alerts per rule.
...
import org.yaproxy.yap.extension.api.YapApiIgnore;
...
public class ScannerParam extends AbstractParam {
    ...
    // YAP: Added support for delayInMs
    ...
    /**
     * Tells whether YAP should add a parameter to GET requests that don't have one.
     *
    ...
    /**
     * Sets whether or not YAP should add a parameter to GET requests that don't have one.
     *
     * @param addQueryParam {@code true} if YAP should add a parameter to GET requests that don't
