 ...
 */
// YAP: 2012/04/25 Added @Override annotation to all appropriate method.
// YAP: 2013/03/03 Issue 546: Remove all template Javadoc comments
// YAP: 2013/07/01 Added content-type checking to allow special POST management by other Variants
// YAP: 2013/08/21 Added a new encoding/decoding model for a correct parameter value interpretation
// YAP: 2013/12/06 Constrained the data content handling to application/x-www-form-urlencoded
// YAP: 2013/12/09 Solved NullPointerException when the request header doesn't contain
...
// YAP: 2016/05/04 Changed to use setParameters(int, List<NameValuePair>)
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2020/05/06 Add method to get a short name of the variant
...
public class VariantFormQuery extends VariantAbstractQuery {
    ...
    public void setMessage(HttpMessage msg) {
        ...
        // YAP: added control for null contentType
