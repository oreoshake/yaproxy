...
// YAP: 2021/05/06 Add method to get a short name of the variant
...
public class VariantURLQuery extends VariantAbstractQuery {
    ...
    protected String getEscapedValue(HttpMessage msg, String value) {
        // YAP: unfortunately the method setQuery() defined inside the httpclient Apache component
    ...
    protected void buildMessage(HttpMessage msg, String query) {
        try {
            // YAP: encoding has been decided before inside the VariantAbstractQuery
