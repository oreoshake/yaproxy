...
import org.yaproxy.yap.extension.alert.ExampleAlertProvider;
...
public interface Plugin extends Runnable, ExampleAlertProvider {
    ...
    // YAP Added isDepreciated, getDelayInMs, setDelayInMs
