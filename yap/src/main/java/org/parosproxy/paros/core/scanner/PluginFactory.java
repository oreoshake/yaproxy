...
// YAP: 2012/04/23 Changed the method loadAllPlugin to reflect the changes made
// in the method DynamicLoader.getFilteredObject(Class).
// YAP: 2012/04/25 Removed unnecessary casts, changed to use the method
...
// YAP: 2013/01/25 Catch any exceptions thrown when loading plugins to allow YAP to still start
// YAP: 2013/03/18 Issue 564: Active scanner can hang if dependencies used
// YAP: 2013/05/02 Re-arranged all modifiers into Java coding standard order
// YAP: 2014/01/16 Added skip support functions and changed obsolete collections
// YAP: 2014/02/12 Issue 1030: Load and save scan policies
// YAP: 2014/02/21 Issue 1043: Custom active scan dialog
// YAP: 2014/05/20 Issue 377: Unfulfilled dependencies hang the active scan
// YAP: 2014/11/19 Issue 1412: Manage scan policies
// YAP: 2014/11/19 Issue 1412: Init scan rule status (quality) from add-on
// YAP: 2015/01/04 Issue 1484: NullPointerException during uninstallation of an add-on with active
// scanners
// YAP: 2015/01/04 Issue 1486: Add-on components leak
// YAP: 2015/07/25 Do not log error if the duplicated scanner is (apparently) a newer/older version
// YAP: 2015/08/19 Issue 1785: Plugin enabled even if dependencies are not, "hangs" active scan
// YAP: 2015/11/02 Issue 1969: Issues with installation of scanners
// YAP: 2015/12/21 Issue 2112: Wrong policy on active Scan
// YAP: 2016/01/26 Fixed findbugs warning
// YAP: 2016/05/04 Use existing Plugin instances when setting them as completed
// YAP: 2016/06/27 Reduce log level when loading the plugins
// YAP: 2016/06/29 Do not log when cloning PluginFactory
// YAP: 2016/07/25 Fix to correct handling of lists in plugins
// YAP: 2017/06/20 Allow to obtain a Plugin by ID.
// YAP: 2017/07/05 Log an error if the Plugin does not have a defined ID.
// YAP: 2017/07/12 Order dependencies before dependent plugins (Issue 3154) and tweak status
// comparison.
...
// YAP: 2022/02/03 Removed loadedPlugin and unloadedPlugin.
...
import org.yaproxy.yap.control.CoreFunctionality;
...
public class PluginFactory {
            ...
            for (int i = 0; i < getLoadedPlugins().size(); i++) {
                ...
                try {
                    ...
                    if (loadedPlugin.isDepreciated()) {
                        // YAP: ignore all depreciated plugins
                    ...
                    // YAP: Changed to use the method Integer.valueOf.
    ...
    public Plugin getPlugin(int id) {
        // YAP: Removed unnecessary cast and changed to use the method
        // Integer.valueOf.
