...
// YAP: 2012/04/25 Added @Override annotation to the appropriate method and removed
// unnecessary casts.
...
// YAP: 2014/06/23 Issue 1151: Active Scan in Scope finishes before scanning all
// messages in scope if multiple domains available
// YAP: 2014/06/23 Issue 1242: Active scanner might use outdated policy settings
// YAP: 2014/07/07 Issue 389: Enable technology scope for scanners
// YAP: 2014/10/24 Issue 1378: Revamp active scan panel
// YAP: 2014/10/25 Issue 1062: Made the scanner load all scannerhooks from the extensionloader
...
// YAP: 2015/10/21 Issue 1576: Removed SiteNode cast no longer needed
// YAP: 2015/12/14 Prevent scans from becoming in undefined state
...
// YAP: 2017/06/29 Remove code duplication in scan()
// YAP: 2018/02/09 Check also its excluded URLs when scanning a context (Issue 4368).
// YAP: 2018/04/19 Added support for publishing events
...
// YAP: 2020/05/19 simplifying duplicate HostProcess for readability
...
import org.yaproxy.yap.extension.script.ScriptCollection;
...
public class Scanner implements Runnable {
    ...
    // YAP: Added a list of scannerhooks
    ...
    // YAP: Added scanner pause option
    ...
    public Scanner(
        ...
        pool = new ThreadPool(scannerParam.getHostPerScan(), "YAP-Scanner-");

        // YAP: Load all scanner hooks from extensionloader.
    ...
    // YAP: Added functionality to add remove and get the attached scannerhooks to the Scanner.
    ...
    void notifyScannerComplete() {
        ...
        // YAP: Invokes scannerhooks with the scannercomplete method.
    ...
    // YAP: support pause and notify parent
    public void pause() {
        this.pause = true;
        ActiveScanEventPublisher.publishScanEvent(
