...
// YAP: 2012/01/23 Changed the method compareTo to compare the fields correctly
// with each other.
// YAP: 2012/03/15 Changed the methods toPluginXML and getUrlParamXML to use the class
...
// YAP: 2012/05/02 Changed to not create a new String in the setters.
// YAP: 2012/07/10 Issue 323: Added getIconUrl()
...
// YAP: 2013/11/16 Issue 866: Alert keeps HttpMessage longer than needed when HistoryReference is
// set/available
...
// YAP: 2015/01/04 Issue 1419: Include alert's evidence in HTML report
// YAP: 2014/01/04 Issue 1475: Alerts with different name from same scanner might not be shown in
// report
// YAP: 2015/02/09 Issue 1525: Introduce a database interface layer to allow for alternative
// implementations
// YAP: 2015/08/24 Issue 1849: Option to merge related issues in reports
// YAP: 2015/11/16 Issue 1555: Rework inclusion of HTML tags in reports
// YAP: 2016/02/26 Deprecate alert as an element of Alert in favour of name
// YAP: 2016/05/25 Normalise equals/hashCode/compareTo
// YAP: 2016/08/10 Issue 2757: Alerts with different request method are considered the same
// YAP: 2016/08/25 Initialise the method to an empty string
// YAP: 2016/09/20 JavaDoc tweaks
// YAP: 2016/10/11 Issue 2592: Differentiate the source of alerts
// YAP: 2017/02/22 Issue 3224: Use TreeCellRenderers to prevent HTML injection issues
// YAP: 2017/08/30: Issue 1984: Ensure element setters set empty string if passed a null value
// YAP: 2017/09/15 Initialise the source from the RecordAlert always.
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2019/07/10 Add utility methods isValidRisk(int) and isValidConfidence(int)
// YAP: 2019/10/21 Add Alert builder.
// YAP: 2020/11/03 Add alertRef field.
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2021/04/30 Add input vector to Alert
// YAP: 2021/06/22 Moved the ReportGenerator.entityEncode method to this class.
// YAP: 2022/02/02 Deleted a deprecated setDetails method.
// YAP: 2022/02/03 Removed SUSPICIOUS, WARNING, MSG_RELIABILITY, setRiskReliability(int, int) and
// getReliability()
// YAP: 2022/02/25 Remove code deprecated in 2.5.0
// YAP: 2022/05/26 Add addTag and removeTag methods
...
import org.yaproxy.yap.utils.XMLStringUtil;
...
public class Alert implements Comparable<Alert> {
    ...
    public enum Source {
        ...
        /**
         * An alert raised by other tools/functionalities in YAP (for example, fuzzer, HTTPS Info
    ...
    private int alertId = -1; // YAP: Changed default alertId
    ...
    // YAP: Added sourceHistoryId to Alert
    ...
    public Alert(RecordAlert recordAlert) {
        ...
        try {
            ...
            // YAP: Just an indication the history record doesn't exist
    ...
    public int compareTo(Alert alert2) {
        ...
        // YAP: changed to compare the field uri with alert2.uri
        result = uri.compareToIgnoreCase(alert2.uri);
        if (result != 0) {
            return result;
        }

        // YAP: changed to compare the field param with alert2.param
    ...
    public String toPluginXML(String urls) {
        StringBuilder sb = new StringBuilder(150); // YAP: Changed the type to StringBuilder.
        sb.append("<alertitem>\r\n");
        ...
        sb.append("  <solution>")
                ...
                .append("</solution>\r\n");
        // YAP: Added otherInfo to the report
    ...
    public String getUrlParamXML() {
        StringBuilder sb = new StringBuilder(200); // YAP: Changed the type to StringBuilder.
