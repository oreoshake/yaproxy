 ...
 */
// YAP: 2012/04/25 Added @Override annotation to the appropriate method and removed unnecessary
// casts.
// YAP: 2012/08/31 Added support for AttackStrength
// YAP: 2013/02/12 Added variant handling the parameters of OData urls
// YAP: 2013/05/02 Re-arranged all modifiers into Java coding standard order
// YAP: 2013/07/02 Changed Vector to generic List and added new variants for GWT, JSON and Headers
// YAP: 2013/07/03 Added variant handling attributes and data contained in XML requests
// YAP: 2013/07/14 Issue 726: Catch active scan variants' exceptions
...
// YAP: 2014/02/07 Issue 1018: Give AbstractAppParamPlugin implementations access to the parameter
// type
// YAP: 2014/02/09 Add custom input vector scripting capabilities
// YAP: 2014/08/14 Issue 1279: Active scanner excluded parameters not working when "Where" is "Any"
// YAP: 2016/06/15 Add VariantHeader based on the current scan options
...
// YAP: 2020/08/27 Moved variants into VariantFactory
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2021/05/06 Add input vector and param to all alerts
// YAP: 2021/06/16 Add support for updating multiple parameters in HttpMessage.
// YAP: 2022/09/08 Use format specifiers instead of concatenation when logging.
// YAP: 2023/01/10 Use logger provided by base class.
...
import org.yaproxy.yap.core.scanner.InputVector;
import org.yaproxy.yap.core.scanner.InputVectorBuilder;
...
public abstract class AbstractAppParamPlugin extends AbstractAppPlugin {
    ...
    public void scan() {
        ...
        for (int i = 0; i < listVariant.size() && !isStop(); i++) {
            ...
            // YAP: Implement pause and resume
