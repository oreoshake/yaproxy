 ...
 */
// YAP: 2011/10/29 Fixed cookie parsing
// YAP: 2012/03/15 Changed to use the classes HttpRequestBody and HttpResponseBody.
...
// YAP: 2012/06/11 Added method boolean isWebSocketUpgrade()
// YAP: 2012/07/02 Implement Message interface for more flexibility.
// YAP: 2012/06/24 Added method to add Cookies of type java.net.HttpCookie to request header
// YAP: 2012/08/01 Issue 332: added support for Modes
// YAP: 2012/08/09 Added HttpSession field
// YAP: 2012/10/08 Issue 391: Performance improvements
// YAP: 2013/01/23 Clean up of exception handling/logging.
// YAP: 2013/04/08 Issue 605: Force intercepts via header
...
// YAP: 2013/11/16 Issue 867: HttpMessage#getFormParams should return an empty TreeSet if
...
// YAP: 2014/03/23 Tidy up, do not allow to set null request/response headers/bodies.
// YAP: 2014/03/28 Issue 1127: 	Allow scripts to generate breaks
// YAP: 2014/06/16 Issue 1217: Table format does not display information when charset is
// present in Content-Type header
// YAP: 2015/02/09 Fix NullPointerException in equals(Object) when comparing with empty messages
// YAP: 2015/08/07 Issue 1768: Update to use a more recent default user agent
// YAP: 2015/08/19 Deprecate/change methods with unused parameters
// YAP: 2016/05/31 Implement hashCode()
// YAP: 2017/02/01 Set whether or not the charset should be determined when setting a (String)
// response.
// YAP: 2017/08/23 queryEquals correct comparison and add JavaDoc. equalType update JavaDoc.
// YAP: 2018/03/13 Added toEventData()
// YAP: 2018/04/04 Add a copy constructor.
// YAP: 2018/08/10 Use non-deprecated HttpRequestHeader constructor (Issue 4846).
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2019/12/09 Address deprecation of getHeaders(String) Vector method.
// YAP: 2020/07/31 Tidy up parameter methods
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2020/12/09 Handle content encodings in request/response bodies.
// YAP: 2021/04/01 Detect WebSocket upgrade messages having multiple Connection directives
// YAP: 2021/05/11 Fixed conversion of Request Method to/from CONNECT
// YAP: 2021/05/14 Add missing override annotation.
...
import org.yaproxy.yap.extension.httpsessions.HttpSession;
import org.yaproxy.yap.model.NameValuePair;
import org.yaproxy.yap.network.HttpEncoding;
import org.yaproxy.yap.network.HttpEncodingDeflate;
import org.yaproxy.yap.network.HttpEncodingGzip;
...
public class HttpMessage implements Message {
    ...
    // private String tag = "";
    // YAP: Added note to HttpMessage
    private String note = "";
    // YAP: Added historyRef
    private HistoryReference historyRef = null;
    // YAP: Added logger
    private static final Logger LOGGER = LogManager.getLogger(HttpMessage.class);
    // YAP: Added HttpSession
    private HttpSession httpSession = null;
    // YAP: Added support for requesting the message to be sent as a particular User
    ...
    /**
     * YAP: New method checking for connection upgrade.
     *
    ...
    /**
     * YAP: New method checking if connection is a Server-Sent Events stream.
     *
     * @return
     */
