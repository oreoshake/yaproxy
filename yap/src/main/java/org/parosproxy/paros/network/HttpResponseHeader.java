 ...
 */
// YAP: 2012/03/15 Added the @Override annotation to the appropriate methods.
// Moved to this class the method getCookieParams().
// YAP: 2012/06/24 Added new method of getting cookies from the request header.
// YAP: 2012/07/11 Added method to check if response type is text/html (isHtml())
// YAP: 2012/08/06 Modified isText() to also consider javascript as text
// YAP: 2013/02/12 Modified isText() to also consider atom+xml as text
// YAP: 2013/03/08 Improved parse error reporting
// YAP: 2014/02/21 i1046: The getHttpCookies() method in the HttpResponseHeader does not properly
// set the domain
// YAP: 2014/04/09 i1145: Cookie parsing error if a comma is used
// YAP: 2015/02/26 Include json as a text content type
// YAP: 2016/06/17 Remove redundant initialisations of instance variables
// YAP: 2017/03/21 Add method to check if response type is json (isJson())
// YAP: 2017/11/10 Allow to set the status code and reason.
// YAP: 2018/02/06 Make the lower/upper case changes locale independent (Issue 4327).
// YAP: 2018/07/23 Add CSP headers.
// YAP: 2018/08/15 Add Server header.
...
// YAP: 2020/11/10 Add convenience method isCss().
