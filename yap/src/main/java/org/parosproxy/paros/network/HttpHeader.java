 ...
 */
// YAP: 2012/01/12 Changed the method parse to use only CRLF as line separator.
// YAP: 2012/03/15 Removed an unnecessary try catch block and unnecessary casting.
// Reworked the method getCharset.
// YAP: 2012/04/23 Added @Override annotation to the appropriate method.
// YAP: 2012/10/04 Changed to initialise the instance variable mVersion with a
// valid version (HttpHeader.HTTP10).
// YAP: 2012/11/01 Issue 410: charset wrapped in quotation marks
...
// YAP: 2013/09/02 Resolved header value setting on setHeader() which manage wrongly the "-" char
...
// YAP: 2016/06/17 Be lenient when parsing charset and accept single quote chars around the value
// YAP: 2016/06/17 Remove redundant initialisations of instance variables
// YAP: 2017/02/08 Change isEmpty to check start line instead of headers (if it has the
// status/request line it's not empty).
// YAP: 2017/03/02 Issue 3226: Added API Key and Nonce headers
// YAP: 2018/02/06 Make the lower/upper case changes locale independent (Issue 4327).
// YAP: 2018/04/24 Add JSON Content-Type.
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2019/12/09 Added getHeaderValues(String) method (returning List) and deprecated
// getHeaders(String) method (returning Vector).
// YAP: 2022/03/11 Added headers: Content-Location, Link, Refresh
// YAP: 2022/09/12 Allow only major HTTP version.
// YAP: 2022/11/17 Add HTTP/2 constant.
...
public abstract class HttpHeader implements java.io.Serializable {
    ...
    public static final String X_YAP_REQUESTID = "x-yap-requestid";
    ...
    // YAP: Issue 410: charset wrapped in quotation marks
    ...
    // YAP: added CORS headers
    public static final String ACCESS_CONTROL_ALLOW_ORIGIN = "access-control-allow-origin";
    public static final String ACCESS_CONTROL_ALLOW_HEADERS = "access-control-allow-headers";
    public static final String ACCESS_CONTROL_ALLOW_METHODS = "access-control-allow-methods";
    public static final String ACCESS_CONTROL_EXPOSE_HEADERS = "access-control-expose-headers";
    // YAP: added "Allow" and "Public" Headers, for response to "OPTIONS" method
    public static final String METHODS_ALLOW = "Allow";
    public static final String METHODS_PUBLIC = "Public"; // IIS specific?
    public static final String X_YAP_SCAN_ID = "x-yap-scan-id";
    public static final String X_YAP_API_KEY = "x-yap-api-key";
    public static final String X_YAP_API_NONCE = "x-yap-api-nonce";
    // YAP: additional standard/defacto headers
    ...
    protected boolean parse(String data) throws Exception {
        ...
        // YAP: always use CRLF to comply with HTTP specification
