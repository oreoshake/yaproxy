 ...
 */
// YAP: 2011/09/19 Added debugging
// YAP: 2012/04/23 Removed unnecessary cast.
// YAP: 2012/05/08 Use custom http client on "Connection: Upgrade" in executeMethod().
//                 Retrieve upgraded socket and save for later use in send() method.
// YAP: 2012/08/07 Issue 342 Support the HttpSenderListener
// YAP: 2012/12/27 Do not read request body on Server-Sent Event streams.
// YAP: 2013/01/03 Resolved Checkstyle issues: removed throws HttpException
//                 declaration where IOException already appears,
//                 introduced two helper methods for notifying listeners.
// YAP: 2013/01/19 Issue 459: Active scanner locking
...
// YAP: 2013/07/10 Issue 720: Cannot send non standard http methods
// YAP: 2013/07/14 Issue 729: Update NTLM authentication code
// YAP: 2013/07/25 Added support for sending the message from the perspective of a User
// YAP: 2013/08/31 Reauthentication when sending a message from the perspective of a User
// YAP: 2013/09/07 Switched to using HttpState for requesting User for cookie management
// YAP: 2013/09/26 Issue 716: YAP flags its own HTTP responses
// YAP: 2013/09/26 Issue 656: Content-length: 0 in GET requests
// YAP: 2013/09/29 Deprecating configuring HTTP Authentication through Options
// YAP: 2013/11/16 Issue 837: Update, always, the HTTP request sent/forward by YAP's proxy
// YAP: 2013/12/11 Corrected log.info calls to use debug
// YAP: 2014/03/04 Issue 1043: Custom active scan dialog
// YAP: 2014/03/23 Issue 412: Enable unsafe SSL/TLS renegotiation option not saved
...
// YAP: 2014/03/29 Issue 1132: HttpSender ignores the "Send single cookie request header" option
// YAP: 2014/08/14 Issue 1291: 407 Proxy Authentication Required while active scanning
// YAP: 2014/10/25 Issue 1062: Added a getter for the HttpClient.
// YAP: 2014/10/28 Issue 1390: Force https on cfu call
// YAP: 2014/11/25 Issue 1411: Changed getUser() visibility
// YAP: 2014/12/11 Added JavaDoc to constructor and removed the instance variable allowState.
// YAP: 2015/04/09 Allow to specify the maximum number of retries on I/O error.
// YAP: 2015/04/09 Allow to specify the maximum number of redirects.
// YAP: 2015/04/09 Allow to specify if circular redirects are allowed.
// YAP: 2015/06/12 Issue 1459: Add an HTTP sender listener script
// YAP: 2016/05/24 Issue 2463: Websocket not proxied when outgoing proxy is set
// YAP: 2016/05/27 Issue 2484: Circular Redirects
// YAP: 2016/06/08 Set User-Agent header defined in options as default for (internal) CONNECT
// requests
// YAP: 2016/06/10 Allow to validate the URI of the redirections before being followed
// YAP: 2016/08/04 Added removeListener(..)
// YAP: 2016/12/07 Add initiator constant for AJAX spider requests
// YAP: 2016/12/12 Add initiator constant for Forced Browse requests
// YAP: 2017/03/27 Introduce HttpRequestConfig.
// YAP: 2017/06/12 Allow to ignore listeners.
// YAP: 2017/06/19 Allow to send a request with custom socket timeout.
// YAP: 2017/11/20 Add initiator constant for Token Generator requests.
// YAP: 2017/11/27 Use custom CookieSpec (YapCookieSpec).
// YAP: 2017/12/20 Apply socket connect timeout (Issue 4171).
// YAP: 2018/02/06 Make the lower case changes locale independent (Issue 4327).
// YAP: 2018/02/19 Added WEB_SOCKET_INITIATOR.
// YAP: 2018/02/23 Issue 1161: Allow to override the global session tracking setting
//                 Fix Session Tracking button sync
// YAP: 2018/08/03 Added AUTHENTICATION_HELPER_INITIATOR.
// YAP: 2018/09/17 Set the user to messages created for redirections (Issue 2531).
// YAP: 2018/10/12 Deprecate getClient(), it exposes implementation details.
// YAP: 2019/03/24 Removed commented and unused sendAndReceive method.
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2019/08/19 Reinstate proxy auth credentials when HTTP state is changed.
// YAP: 2019/09/17 Use remove() instead of set(null) on IN_LISTENER.
// YAP: 2019/09/25 Add option to disable cookies
// YAP: 2020/04/20 Configure if the names should be resolved or not (Issue 29).
// YAP: 2020/09/04 Added AUTHENTICATION_POLL_INITIATOR
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2020/12/09 Set content encoding to the response body.
// YAP: 2021/05/14 Remove redundant type arguments and empty statement.
// YAP: 2022/01/04 Add initiator constant OAST_INITIATOR for OAST requests.
// YAP: 2022/04/08 Deprecate getSSLConnector() and executeMethod.
// YAP: 2022/04/10 Add support for unencoded redirects
// YAP: 2022/04/11 Deprecate set/getUserAgent() and remove userAgent/modifyUserAgent().
// YAP: 2022/04/11 Prevent null listeners and add JavaDoc to add/removeListener.
// YAP: 2022/04/23 Use main connection options directly.
// YAP: 2022/04/24 Notify listeners of all redirects followed.
// YAP: 2022/04/24 Move network initialisations from YAP class.
// YAP: 2022/04/24 Allow to download to file.
// YAP: 2022/04/27 Expose global HTTP state enabled status.
// YAP: 2022/04/27 Use latest proxy settings always.
// YAP: 2022/04/29 Deprecate setAllowCircularRedirects.
// YAP: 2022/05/04 Always use single cookie request header.
// YAP: 2022/05/04 Use latest timeout/user-agent always.
// YAP: 2022/05/20 Address deprecation warnings with ConnectionParam.
// YAP: 2022/05/29 Remove redundant checks and create SSLConnector always.
// YAP: 2022/05/30 Use shared connection pool.
// YAP: 2022/06/03 Remove commented code and make listeners comparator final.
// YAP: 2022/06/03 Move implementation to HttpSenderParos.
// YAP: 2022/06/05 Remove usage of HttpException.
// YAP: 2022/06/07 Address deprecation warnings with HttpSenderParos.
// YAP: 2022/06/13 Added param digger initiator.
// YAP: 2022/12/09 Allow to restore HttpSenderImpl state.
// YAP: 2023/03/31 Deprecate CFU initiator and add file download with configs.
...
import org.yaproxy.yap.network.HttpSenderContext;
import org.yaproxy.yap.network.HttpSenderImpl;
