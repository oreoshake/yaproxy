...
// YAP: 2013/01/25 Issue 462: SSLSocketFactory with TLS enabled and default Cipher options
// YAP: 2013/06/01 Issue 669: Certificate algorithm constraints in Java 1.7
// YAP: 2014/03/23 Tidy up, removed and deprecated unused methods other minor changes
// YAP: 2014/03/23 Issue 951: TLS' versions 1.1 and 1.2 not enabled by default
// YAP: 2014/07/17 Issue 704: YAP Error: handshake alert: unrecognized_name
// YAP: 2014/08/14 Issue 1184: Improve support for IBM JDK
// YAP: 2014/08/14 Issue 1274: YAP Error [javax.net.ssl.SSLException]: Unsupported record version
// SSLv2Hello
// YAP: 2014/10/28 Issue 1390: Force https on cfu call
// YAP: 2015/10/13 Issue 1975: Allow use of default disabled cipher suites (such as RC4-SHA)
// YAP: 2017/04/14 Validate that SSLv2Hello is set in conjunction with at least one SSL/TLS version.
// YAP: 2017/09/22 Rely on SNI if the domain is no known when creating the SSL/TLS tunnel.
// YAP: 2017/11/07 Pass the listeningIpAddress when creating the SSL/TLS tunnel. Check if hostname
// is an ipAddress when creating the SSL/TLS tunnel.
// YAP: 2018/06/08 Don't enable client cert if none set (Issue 4745).
// YAP: 2019/02/26 Disable TLS 1.3 by default as it currently fails with Java 11
// YAP: 2019/06/01 Normalise line endings.
// YAP: 2019/06/05 Normalise format/style.
// YAP: 2020/04/20 Let SOCKS proxy resolve hosts if set (Issue 29).
// YAP: 2020/10/30 Add SNI hostname when using SOCKS with unresolved addresses.
// YAP: 2020/11/26 Use Log4j 2 classes for logging.
// YAP: 2021/11/23 Allow to set certificates service.
// YAP: 2022/05/29 Address deprecations related to client certificates.
// YAP: 2022/06/07 Deprecate the class.
// YAP: 2022/09/21 Use format specifiers instead of concatenation when logging.
// YAP: 2022/09/27 Remove usage of Commons Validator class.
...
public class SSLConnector
    ...
    // YAP: removed ServerSocketFaktory
    ...
    // YAP: removed server socket methods
