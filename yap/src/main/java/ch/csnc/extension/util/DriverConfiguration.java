 ...
 *
 * As of October 2014 Compass Security AG granted the OWASP YAP Project
...
public class DriverConfiguration {
    ...
    private void load() {
        ...
        try {
            YapXmlConfiguration configuration =
                    file != null ? new YapXmlConfiguration(file) : new YapXmlConfiguration(url);
