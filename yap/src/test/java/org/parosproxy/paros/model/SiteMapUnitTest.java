...
class SiteMapUnitTest {
    ...
    void shouldNotReturnCachedHistoryReference() throws Exception {
        ...
        given(href.getHistoryType()).willReturn(HistoryReference.TYPE_YAP_USER);
    ...
    void shouldNotUseCacheForDifferentHistoryReference() throws Exception {
        ...
        given(href1.getHistoryType()).willReturn(HistoryReference.TYPE_YAP_USER);
        given(href2.getHistoryType()).willReturn(HistoryReference.TYPE_YAP_USER);
