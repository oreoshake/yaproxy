...
class VariantAbstractQueryUnitTest {
    ...
    void shouldFailToProcessUndefinedParameters() {
        // Given
        VariantAbstractQuery variantAbstractQuery = new VariantAbstractQueryImpl();
        List<org.yaproxy.yap.model.NameValuePair> undefinedParameters = null;
        // When / Then
        assertThrows(
    ...
    void shouldCreateOneDummyNameValuePairIfNoParametersProvidedAndAddQueryParamTrue() {
        ...
        List<org.yaproxy.yap.model.NameValuePair> noParameters = parameters();
        // When
    ...
    void shouldCreateNameValuePairsFromProvidedParameters() {
        // Given
        VariantAbstractQuery variantAbstractQuery = new VariantAbstractQueryImpl();
        List<org.yaproxy.yap.model.NameValuePair> parameters =
    ...
    void shouldNotAccumulateProvidedParameters() {
        ...
        List<org.yaproxy.yap.model.NameValuePair> parameters =
                parameters(parameter("a", "b"), parameter("c", "d"));
        List<org.yaproxy.yap.model.NameValuePair> otherParameters =
    ...
    void shouldUseInjectedNameWhenSettingArrayParameter() {
        ...
        List<org.yaproxy.yap.model.NameValuePair> parameters = parameters(parameter("a[]", "b"));
        variantAbstractQuery.setParameters(NAME_VALUE_PAIR_TYPE, parameters);
        HttpMessage message = createMessage();
        // When
        variantAbstractQuery.setParameter(message, param("a[]", "b", 0), "y", "z");
    ...
    private static org.yaproxy.yap.model.NameValuePair parameter(String name, String value) {
        return new org.yaproxy.yap.model.NameValuePair() {
    ...
    private static List<org.yaproxy.yap.model.NameValuePair> parameters(
            org.yaproxy.yap.model.NameValuePair... parameters) {
