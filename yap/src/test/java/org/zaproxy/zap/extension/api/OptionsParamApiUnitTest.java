...
class OptionsParamApiUnitTest {
    ...
    void shouldDefaultToNoPersistentCallbacks() {
        ...
        OptionsParamApi param = new OptionsParamApi();
        // When
        param.load(new YapXmlConfiguration());
        // Then
    ...
    void shouldLoadPersistentCallbacks() {
        ...
        String url1 = "https://yap//yapCallBackUrl/1234";
        String url2 = "https://yap//yapCallBackUrl/5678";
    ...
    void shouldRemovePersistentCallbacks() {
        ...
        OptionsParamApi param = new OptionsParamApi();
        YapXmlConfiguration config = new YapXmlConfiguration();
        String url = "https://yap//yapCallBackUrl/1234";
    ...
    private static class Configuration extends YapXmlConfiguration {
