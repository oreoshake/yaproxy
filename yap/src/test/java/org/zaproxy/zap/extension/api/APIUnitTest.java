...
class APIUnitTest {
    ...
    @Test
    void shouldCreateBaseUrlWithHttpSchemeAndYapAddressIfProxyingAndNotSecure() {
        // Given
        ...
        // Then
        assertThat(baseUrl, is(equalTo("http://yap/")));
    }

    @Test
    void shouldCreateBaseUrlWithHttpsSchemeAndYapAddressIfProxyingAndSecure() {
        // Given
        boolean proxying = true;
        boolean secure = true;
        API api = new API();
        ...
        String baseUrl = api.getBaseURL(proxying);
        // Then
        assertThat(baseUrl, is(equalTo("https://yap/")));
    }
    ...
    @Test
    void
            shouldCreateBaseUrlWithApiRequestWithHttpSchemeYapAddressAndApiNonceIfProxyingNotSecureAndNotView() {
        // Given
        boolean proxying = true;
        boolean secure = false;
        API api = new API();
        ...
        // Then
        assertThat(baseUrl, startsWith("http://yap/JSON/test/action/test/?apinonce="));
    ...
    @Test
    void
            shouldCreateBaseUrlWithApiRequestWithHttpsSchemeYapAddressAndApiNonceIfProxyingIsSecureAndNotView() {
        // Given
        boolean proxying = true;
        boolean secure = true;
        API api = new API();
        ...
        String baseUrl =
                api.getBaseURL(API.Format.JSON, "test", API.RequestType.action, "test", proxying);
        // Then
        assertThat(baseUrl, startsWith("https://yap/JSON/test/action/test/?apinonce="));
        assertThat(baseUrl, endsWith("&"));
        assertApiNonceMatch(api, baseUrl);
    }
    ...
    @Test
    void
            shouldCreateBaseUrlWithApiRequestWithHttpSchemeYapAddressAndNoApiNonceIfProxyingNotSecureAndView() {
        // Given
        boolean proxying = true;
        boolean secure = false;
        API api = new API();
        ...
        // Then
        assertThat(baseUrl, is(equalTo("http://yap/JSON/test/view/test/")));
    }

    @Test
    void
            shouldCreateBaseUrlWithApiRequestWithHttpsSchemeYapAddressAndNoApiNonceIfProxyingIsSecureAndView() {
        // Given
        boolean proxying = true;
        boolean secure = true;
        API api = new API();
        ...
        String baseUrl =
                api.getBaseURL(API.Format.JSON, "test", API.RequestType.view, "test", proxying);
        // Then
        assertThat(baseUrl, is(equalTo("https://yap/JSON/test/view/test/")));
    }
    ...
    @Test
    void shouldHandleShortcutIfYapRequest() throws Exception {
        // Given
        API api = createApiWithoutKey();
        TestApiImplementor apiImplementor = new TestApiImplementor();
        String shortcut = "shortcut";
    ...
    @Test
    void shouldHandleShortcutIfSecureYapRequest() throws Exception {
        // Given
        API api = createApiWithoutKey();
        TestApiImplementor apiImplementor = new TestApiImplementor();
        String shortcut = "shortcut";
    ...
    private static boolean isApiNonceValid(API api, String requestPath, String nonce) {
        try {
            ...
            when(request.getHeader(HttpHeader.X_YAP_API_NONCE)).thenReturn(nonce);
    ...
    private static OptionsParamApi createOptionsParamApi() {
        ...
        optionsParamApi.load(new YapXmlConfiguration());
    ...
    private static org.parosproxy.paros.core.proxy.ProxyParam createProxyParam(
        ...
        proxyParam.load(new YapXmlConfiguration());
