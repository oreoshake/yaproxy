...
class HttpSenderAuthHeaderListenerUnitTest {
    ...
    void shouldTreatEmptyStringsAsNulls() {
        // Given
        HashMap<String, String> map = new HashMap<>();
        map.put(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER_VALUE, "");
        map.put(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER_SITE, "");
        map.put(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER, "");
        new HttpSenderAuthHeaderListener(map::get);

        // When / Then
        assertThat(
                ScriptVars.getGlobalVar(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER),
                is(equalTo(HttpHeader.AUTHORIZATION)));
        assertThat(
                ScriptVars.getGlobalVar(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER_VALUE),
                is(equalTo(null)));
        assertThat(
                ScriptVars.getGlobalVar(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER_SITE),
                is(equalTo(null)));
    }
    ...
    void shouldAddAuthHeaderWhenDefined() {
        ...
        map.put(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER_VALUE, headerValue);
        authHeaderListener = new HttpSenderAuthHeaderListener(map::get);
    ...
    void shouldAddSpecifiedHeaderWhenDefined() {
        ...
        String headerValue = "example header value";
        map.put(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER, headerType);
        map.put(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER_VALUE, headerValue);
        authHeaderListener = new HttpSenderAuthHeaderListener(map::get);
    ...
    void shouldAddSpecifiedHeaderToSpecifiedHost() throws Exception {
        ...
        map.put(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER, headerType);
        map.put(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER_VALUE, headerValue);
        map.put(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER_SITE, headerHost);
        authHeaderListener = new HttpSenderAuthHeaderListener(map::get);
    ...
    void shouldAddSpecifiedHeaderWhenSetDirectly() {
        ...
        String headerValue = "example header value";
        HttpSenderAuthHeaderListener listener = new HttpSenderAuthHeaderListener(map::get);
        ScriptVars.setGlobalVar(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER, headerType);
        ScriptVars.setGlobalVar(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER_VALUE, headerValue);
    ...
    void shouldNotAddSpecifiedHeaderWhenUnsetDirectly() {
        ...
        map.put(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER, headerType);
        HttpSenderAuthHeaderListener listener = new HttpSenderAuthHeaderListener(map::get);
        ScriptVars.setGlobalVar(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER_VALUE, null);
    ...
    void shouldAddDefaultHeaderWhenSpecifiedHeaderUnsetDirectly() {
        ...
        map.put(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER, headerType);
        HttpSenderAuthHeaderListener listener = new HttpSenderAuthHeaderListener(map::get);
        ScriptVars.setGlobalVar(HttpSenderAuthHeaderListener.YAP_AUTH_HEADER, null);
