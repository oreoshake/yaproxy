...
class SpiderHttpHeaderParserUnitTest extends SpiderParserTestUtils {
    ...
    private org.yaproxy.yap.spider.parser.SpiderHttpHeaderParser headerParser;

    @BeforeEach
    void setup() {
        org.yaproxy.yap.spider.SpiderParam spiderOptions =
                mock(org.yaproxy.yap.spider.SpiderParam.class);
        headerParser = new org.yaproxy.yap.spider.parser.SpiderHttpHeaderParser(spiderOptions);
    }
