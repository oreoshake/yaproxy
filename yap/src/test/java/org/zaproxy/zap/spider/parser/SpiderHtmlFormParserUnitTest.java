 ...
 */
package org.yaproxy.yap.spider.parser;
...
import org.yaproxy.yap.utils.Pair;
...
class SpiderHtmlFormParserUnitTest extends SpiderParserTestUtils {
    ...
    void shouldFailToCreateParserWithUndefinedSpiderOptions() {
        // Given
        org.yaproxy.yap.spider.SpiderParam undefinedSpiderOptions = null;
        // When / Then
        assertThrows(
    ...
    void shouldFailToEvaluateAnUndefinedMessage() {
        ...
        org.yaproxy.yap.spider.parser.SpiderHtmlFormParser htmlParser =
    ...
    void shouldNotParseMessageIfFormProcessingIsDisabled() {
        // Given
        org.yaproxy.yap.spider.SpiderParam spiderOptions = createSpiderParamWithConfig();
    ...
    void shouldSetValuesToFieldsWithNoValueWhenParsingGetForm() {
        ...
        assertThat(
                listener.getUrlsFound(),
                contains(
                        "http://example.org/?_file=test_file.txt&_hidden&_no-type=YAP&_password=YAP&_text=YAP&submit=Submit",
        ...
        assertThat(
                ...
                contains(
                        postResource(
                                ...
                                1,
                                "http://example.org/",
                                "_hidden=&_no-type=YAP&_text=YAP&_password=YAP&_file=test_file.txt&submit=Submit"),
                        postResource(
                                msg,
                                1,
    ...
    private static org.yaproxy.yap.spider.parser.SpiderHtmlFormParser createSpiderHtmlFormParser() {
    ...
    private static org.yaproxy.yap.spider.parser.SpiderHtmlFormParser createSpiderHtmlFormParser(
        ...
        spiderOptions.setProcessForm(true);
        spiderOptions.setPostForm(true);
        return new org.yaproxy.yap.spider.parser.SpiderHtmlFormParser(
