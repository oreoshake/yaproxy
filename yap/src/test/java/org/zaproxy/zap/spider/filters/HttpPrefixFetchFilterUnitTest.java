...
class HttpPrefixFetchFilterUnitTest {
    ...
    void shouldFailToCreateFetchFilterWithUndefinedURI() {
        ...
        assertThrows(
                ...
                () -> new org.yaproxy.yap.spider.filters.HttpPrefixFetchFilter(undefinedUri));
    }
    ...
    void shouldFailToCreateFetchFilterWithNoScheme() throws Exception {
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> new org.yaproxy.yap.spider.filters.HttpPrefixFetchFilter(prefixUri));
    }
    ...
    void shouldNotAddPathToNormalisedPrefixIfPrefixDoesNotHavePath() throws Exception {
        ...
        org.yaproxy.yap.spider.filters.HttpPrefixFetchFilter fetchFilter =
                new org.yaproxy.yap.spider.filters.HttpPrefixFetchFilter(prefixUri);
        // When
    ...
    void shouldFilterUndefinedUriAsOutOfScope() throws Exception {
        ...
        org.yaproxy.yap.spider.filters.HttpPrefixFetchFilter fetchFilter =
                new org.yaproxy.yap.spider.filters.HttpPrefixFetchFilter(prefixUri);
        // When
        org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus filterStatus =
    ...
    void shouldFilterUriWithSamePathPrefixAsValid() throws Exception {
        ...
        assertThat(
                filterStatus,
                is(equalTo(org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus.VALID)));
    }
