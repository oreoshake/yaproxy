...
class SpiderSitemapXMLParserUnitTest extends SpiderParserTestUtils {
    ...
    void shouldNotFailToEvaluateAnUndefinedMessage() {
        ...
        org.yaproxy.yap.spider.parser.SpiderSitemapXMLParser spiderParser =
    ...
    void shouldNotParseMessageIfParseOfSitemapXmlIsDisabled() {
        // Given
        org.yaproxy.yap.spider.SpiderParam params = createSpiderParamWithConfig();
        params.setParseSitemapXml(false);
        org.yaproxy.yap.spider.parser.SpiderSitemapXMLParser spiderParser =
                new org.yaproxy.yap.spider.parser.SpiderSitemapXMLParser(params);
        HttpMessage message = createMessageWith("NoUrlsSitemap.xml");
        // When
    ...
    private static org.yaproxy.yap.spider.parser.SpiderSitemapXMLParser
            createSpiderSitemapXMLParser() {
        org.yaproxy.yap.spider.SpiderParam params = createSpiderParamWithConfig();
        params.setParseSitemapXml(true);
        return new org.yaproxy.yap.spider.parser.SpiderSitemapXMLParser(params);
    }
