...
class DefaultParseFilterUnitTest {
    ...
    void shouldCreateDefaultParseFilterWithConfigsAndResourceBundleSet() {
        // Given
        org.yaproxy.yap.spider.SpiderParam configs = new org.yaproxy.yap.spider.SpiderParam();
        // When / Then
    ...
    void shouldFailToCreateDefaultParseFilterWithNullConfigs() {
        // Given
        org.yaproxy.yap.spider.SpiderParam configs = null;
        // When / Then
        assertThrows(
    ...
    private static org.yaproxy.yap.spider.SpiderParam createSpiderParam(
            final int maxParseSizeBytes) {
        return new org.yaproxy.yap.spider.SpiderParam() {
