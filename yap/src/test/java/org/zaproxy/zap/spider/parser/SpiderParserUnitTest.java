...
class SpiderParserUnitTest extends SpiderParserTestUtils {
    ...
    void shouldNotifyListenersOfResourceFound() {
        ...
        org.yaproxy.yap.spider.parser.SpiderResourceFound resourceFound1 =
                mock(org.yaproxy.yap.spider.parser.SpiderResourceFound.class);
        org.yaproxy.yap.spider.parser.SpiderResourceFound resourceFound2 =
                mock(org.yaproxy.yap.spider.parser.SpiderResourceFound.class);
        // When
    ...
    private static class TestSpiderParser extends SpiderParser {
        ...
        TestSpiderParser() {
            super(mock(org.yaproxy.yap.spider.SpiderParam.class));
        }
