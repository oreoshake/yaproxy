 ...
 */
package org.yaproxy.yap.spider.filters;
...
class DefaultFetchFilterUnitTest {
    ...
    private org.yaproxy.yap.spider.filters.DefaultFetchFilter filter;

    @BeforeEach
    void setUp() {
        filter = new org.yaproxy.yap.spider.filters.DefaultFetchFilter();
    }
    ...
    void shouldFilterUriWithNonSchemeAsIllegalProtocol() throws Exception {
        ...
        // When
        org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus status = filter.checkFilter(uri);
        // Then
        assertThat(
                status,
                is(
                        equalTo(
                                org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus
                                        .ILLEGAL_PROTOCOL)));
    }
    ...
    void shouldFilterUriWithHttpSchemeAsOutOfScopeByDefault() throws Exception {
        ...
        assertThat(
                status,
                is(equalTo(org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus.OUT_OF_SCOPE)));
    }
    ...
    void shouldFilterInScopeUriAsValid() throws Exception {
        ...
        // Then
        assertThat(
                status, is(equalTo(org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus.VALID)));
    }
    ...
    void shouldFilterExcludedInScopeUriAsUserRules() throws Exception {
        ...
        assertThat(
                status,
                is(equalTo(org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus.USER_RULES)));
    }
    ...
    void shouldFilterOutOfContextUriAsOutOfContext() throws Exception {
        ...
        assertThat(
                status,
                is(equalTo(org.yaproxy.yap.spider.filters.FetchFilter.FetchStatus.OUT_OF_CONTEXT)));
    }
    ...
    private static List<org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher> domainsAlwaysInScope(
            String... domains) {
        ...
        for (String domain : domains) {
            domainsAlwaysInScope.add(new org.yaproxy.yap.spider.DomainAlwaysInScopeMatcher(domain));
        }
