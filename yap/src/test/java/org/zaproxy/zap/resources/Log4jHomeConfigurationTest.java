 ...
 */
package org.yaproxy.yap.resources;
...
class Log4jHomeConfigurationTest {
    ...
    void shouldHaveExpectedName() {
        ...
        // Then
        assertThat(name, is(equalTo("YAP Home Config")));
    }
    ...
    @Test
    void shouldHaveYapPackageSetToInfo() {
        // Given / When
        LoggerConfig loggerConfig = configuration.getLoggerConfig("org.yaproxy.yap");
        // Then
        assertThat(loggerConfig, is(notNullValue()));
        assertThat(loggerConfig.getLevel(), is(equalTo(Level.INFO)));
    }
