...
/** Unit test for {@link YapXmlConfiguration}. */
class YapXmlConfigurationUnitTest {
    ...
    void shouldSaveNewConfigurationIndented() throws Exception {
        ...
        YapXmlConfiguration conf = new YapXmlConfiguration();
    ...
    void shouldSaveLoadedConfigurationIndented() throws Exception {
        ...
        YapXmlConfiguration conf = new YapXmlConfiguration(inputStream);
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        // When
        conf.save(outputStream);
        // Then
