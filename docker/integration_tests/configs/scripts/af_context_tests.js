/*
	A YAP standalone script for testing Automation Framework (AF) context support.
...
var base = '/yap/wrk/configs/plans/contexts'
var results = '/yap/wrk/output/'

var AutomationPlan = Java.type("org.yaproxy.addon.automation.AutomationPlan");
